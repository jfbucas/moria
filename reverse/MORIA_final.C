...

{
  ...
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5499);
...

{
  ...
  write_padded_number(2,*(int *)0xe52d /* dungeon_level */,*(int *)0xe52d /* dungeon_level */ >> 0xf);
  flush_output(uVar3,uVar4);
  uVar3 = 0xe654;
  uVar4 = unaff_DS;
  write_padded_string(0,0x266,0x214c);
  write_padded_number(6,*(undefined2 *)0xb8c8 /* gold_low */,*(undefined2 *)0xb8ca /* gold_high */);
  write_padded_string(0,0x26a,0x214c);
  write_padded_number(4,*(int *)0xb870 /* current_hp */,*(int *)0xb870 /* current_hp */ >> 0xf);
  write_bytes(0,CONCAT11(extraout_AH,0x2f));
  write_padded_number(3,*(int *)0xb872 /* max_hp */,*(int *)0xb872 /* max_hp */ >> 0xf);
  write_padded_string(0,0x270,0x214c);
  write_padded_number(3,*(int *)0xb87a /* intelligence */,*(int *)0xb87a /* intelligence */ >> 0xf);
  write_padded_string(0,0x277,0x214c);
  write_padded_number(3,*(int *)0xb878 /* strength */,*(int *)0xb878 /* strength */ >> 0xf);
  write_padded_string(0,0x27e,0x214c);
  write_padded_number(3,*(int *)0xb874 /* current_mana */,*(int *)0xb874 /* current_mana */ >> 0xf);
  write_padded_string(0,0x285,0x214c);
  flush_output(uVar3,uVar4);
  if (*(int *)0xb880 /* base_ac */ < 1) {
    print_space();
  }
  else {
    uVar3 = 0xe654;
  ...
  uVar3 = 0xe654;
  uVar4 = unaff_DS;
  write_padded_number(1,*(int *)0xb880 /* base_ac */,*(int *)0xb880 /* base_ac */ >> 0xf);
  write_padded_string(0,0x28e,0x214c);
  write_padded_number(2,*(int *)0xb888 /* player_level */,*(int *)0xb888 /* player_level */ >> 0xf);
  write_bytes(0,CONCAT11(extraout_AH_00,0x2f));
  write_padded_number(4,*(int *)0xb886 /* experience */,*(int *)0xb886 /* experience */ >> 0xf);
  flush_output(uVar3,uVar4);
  update_screen_double();
...

{
  ...
  pcVar2 = (char *)*(undefined4 *)0xb91e /* inventory_list */;
...

{
  ...
  *param_2 = 1;
  if ((((((int)((ulong)*param_3 >> 0x10) == *(int *)0xb928) && ((int)*param_3 == *(int *)0xb926 /* equipped_shield */)) ||
       (((int)((ulong)*param_3 >> 0x10) == *(int *)0xb92c && ((int)*param_3 == *(int *)0xb92a /* equipped_armor */)))) ||
      (((int)((ulong)*param_3 >> 0x10) == *(int *)0xb934 && ((int)*param_3 == *(int *)0xb932 /* equipped_ring2 */)))) ||
     (((int)((ulong)*param_3 >> 0x10) == *(int *)0xb930 && ((int)*param_3 == *(int *)0xb92e /* equipped_ring1 */)))) {
    if (*(char *)((int)*param_3 + 0x14) == '\0') {
      if (((int)((ulong)*param_3 >> 0x10) == *(int *)0xb928) && ((int)*param_3 == *(int *)0xb926 /* equipped_shield */)) {
        *(undefined2 *)0xb926 /* equipped_shield */ = 0;
        *(undefined2 *)0xb928 = 0;
        *(undefined2 *)0xb87c = 0;
      }
      if (((int)((ulong)*param_3 >> 0x10) == *(int *)0xb92c) && ((int)*param_3 == *(int *)0xb92a /* equipped_armor */)) {
        *(undefined2 *)0xb92a /* equipped_armor */ = 0;
        *(undefined2 *)0xb92c = 0;
        *(undefined2 *)0xb87e = 0;
      }
      if (((int)((ulong)*param_3 >> 0x10) == *(int *)0xb934) && ((int)*param_3 == *(int *)0xb932 /* equipped_ring2 */)) {
        *(undefined2 *)0xb932 /* equipped_ring2 */ = 0;
        *(undefined2 *)0xb934 = 0;
        *(undefined2 *)0xb884 = 0;
      }
      if (((int)((ulong)*param_3 >> 0x10) == *(int *)0xb930) && ((int)*param_3 == *(int *)0xb92e /* equipped_ring1 */)) {
        *(undefined2 *)0xb92e /* equipped_ring1 */ = 0;
        *(undefined2 *)0xb930 = 0;
      }
    }
    else {
    ...
    *(int *)0xb880 /* base_ac */ = *(int *)0xb87c + *(int *)0xb87e;
  }
  else if (((int)((ulong)*param_3 >> 0x10) == *(int *)0xb924) && ((int)*param_3 == *(int *)0xb922 /* wielded_weapon */))
  {
    *(undefined2 *)0xb922 /* wielded_weapon */ = 0;
    *(undefined2 *)0xb924 = 0;
    *(undefined2 *)0xb882 = 0;
  }
  else {
...

{
  ...
  if ((*(char *)0xb8f2 /* is_teleporting */ == '\0') ||
     (cVar2 = is_position_in_bounds(param_1,param_2 + *(int *)(param_1 + -2),
                            param_3 + *(int *)(param_1 + -4)), cVar2 != '\0')) {
    if (*(char *)(param_3 * MAP_WIDTH + param_2 + -0xc) == ' ') {
      if (*(char *)(*(int *)0xe52d /* dungeon_level */ * 0x719 + param_3 * MAP_WIDTH + param_2 + 0x70d) != '\0') {
        uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
        iVar3 = (int)uVar1 + param_3 * MAP_WIDTH + param_2;
        uVar4 = iVar3 == 0;
        uVar7 = CONCAT11((char)((uint)(param_3 * MAP_WIDTH) >> 8),*(undefined1 *)(iVar3 + -0x50));
        puVar5 = local_2c;
        uVar6 = unaff_SS;
        pad_and_copy_buffer(0x20,0xb76f,unaff_DS);
        create_bit_mask(puVar5,uVar6,uVar7);
        if (((!(bool)uVar4) && (*(char *)0xb8f2 /* is_teleporting */ == '\0')) && (*(char *)0xb8ee /* needs_full_update */ == '\0')) {
          return;
        }
      }
      if (*(char *)0xb8ee /* needs_full_update */ == '\0') {
        *(undefined1 *)(*(int *)0xe52d /* dungeon_level */ * 0x719 + param_3 * MAP_WIDTH + param_2 + 0x70d) = 1;
      }
      uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      iVar3 = (int)uVar1 + param_3 * MAP_WIDTH + param_2;
      uVar4 = iVar3 == 0;
      ...
      create_bit_mask(puVar5,uVar6,uVar7);
      if (((bool)uVar4) || (*(char *)0xb8f0 /* confusion_lock */ == '\0')) {
        uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
        iVar3 = (int)uVar1 + param_3 * MAP_WIDTH + param_2;
        uVar4 = iVar3 == 0;
        uVar7 = CONCAT11((char)((uint)(param_3 * MAP_WIDTH) >> 8),*(undefined1 *)(iVar3 + -0x50));
        ...
        if ((bool)uVar4) {
          ...
          uVar6 = 0xe654;
          uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
          write_bytes(0,CONCAT11((char)((uint)(param_3 * MAP_WIDTH) >> 8),
                                   *(undefined1 *)((int)uVar1 + param_3 * MAP_WIDTH + param_2 + -0x50)));
          flush_output(uVar6,unaff_DS);
        }
        else {
          uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
          if (*(char *)((int)uVar1 + param_3 * MAP_WIDTH + param_2 + -0x50) != ' ') {
            puVar5 = local_16c;
            uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
            uVar6 = unaff_SS;
            char_to_pascal_string(CONCAT11((char)((uint)(param_3 * MAP_WIDTH) >> 8),
                                   *(undefined1 *)((int)uVar1 + param_3 * MAP_WIDTH + param_2 + -0x50)));
...

{
  ...
  if (*(char *)0xb8ed /* is_blind */ == '\0') {
    ...
    light_radius = *(int *)0xb888 /* player_level */ + 5;
    if (*(char *)0xb8f2 /* is_teleporting */ == '\0') {
      local_6 = 0;
      local_4 = 0;
    }
    else {
      local_6 = 0xc - *(int *)0xb86c /* player_y */;
      local_4 = 0x27 - *(int *)0xb86e /* player_x */;
    }
    if (*(char *)0xb8f2 /* is_teleporting */ == '\0') {
      if (*(char *)0xb8ee /* needs_full_update */ != '\0') {
        local_16 = *(uint *)0xe537 /* max_visible_row */;
        current_row = *(uint *)0xe535 /* min_visible_row */;
      ...
      local_16 = *(int *)0xe537 /* max_visible_row */ + 1;
      current_row = *(int *)0xe535 /* min_visible_row */ - 1;
      if ((int)current_row <= (int)local_16) {
        while( true ) {
          if ((1 < (int)((current_row + 0xd) - *(int *)0xb86c /* player_y */)) &&
             (iVar3 = (current_row + 0xd) - *(int *)0xb86c /* player_y */, iVar3 < 0x19)) {
            validate_window_coords((current_row + 0xd) - *(int *)0xb86c /* player_y */,CONCAT11((char)((uint)iVar3 >> 8),1));
          }
          update_screen_double();
          if (current_row == local_16) break;
          current_row = current_row + 1;
    ...
    current_row = *(int *)0xb86c /* player_y */;
    do {
      current_row = current_row + -1;
      current_col = -1;
      while (explore_tile_at_position(&stack0xfffe,current_col + *(int *)0xb86e /* player_x */,current_row), current_col != 1) {
        current_col = current_col + 1;
      }
      uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      iVar3 = (int)uVar1 + current_row * MAP_WIDTH + *(int *)0xb86e /* player_x */;
      uVar6 = iVar3 == 0;
    ...
    } while (((bool)uVar6) && (*(int *)0xb86c /* player_y */ - current_row != light_radius));
    *(int *)0xe535 /* min_visible_row */ = current_row;
    current_row = *(int *)0xb86c /* player_y */;
    do {
      current_row = current_row + 1;
      current_col = -1;
      ...
      pad_and_copy_buffer(0x20,0xb76f,unaff_DS);
      create_bit_mask(puVar7,uVar8,uVar4);
    } while (((bool)uVar6) && (current_row - *(int *)0xb86c /* player_y */ != light_radius));
    *(int *)0xe537 /* max_visible_row */ = current_row;
    current_row = *(int *)0xb86e /* player_x */;
    do {
      current_row = current_row + -1;
      current_col = -1;
      while (explore_tile_at_position(&stack0xfffe,current_row,*(int *)0xb86c /* player_y */ + current_col), current_col != 1) {
        current_col = current_col + 1;
      }
      uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      iVar3 = (int)uVar1 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + current_row;
      uVar6 = iVar3 == 0;
      uVar4 = CONCAT11((char)((uint)(*(int *)0xb86c /* player_y */ * MAP_WIDTH) >> 8),*(undefined1 *)(iVar3 + -0x50));
      puVar7 = row_bitmask;
      uVar8 = unaff_SS;
      pad_and_copy_buffer(0x20,0xb76f,unaff_DS);
      create_bit_mask(puVar7,uVar8,uVar4);
    } while (((bool)uVar6) && (*(int *)0xb86e /* player_x */ - current_row != light_radius));
    current_row = *(uint *)0xb86e /* player_x */;
    do {
      current_row = current_row + 1;
      current_col = -1;
      while (explore_tile_at_position(&stack0xfffe,current_row,*(int *)0xb86c /* player_y */ + current_col), current_col != 1) {
      ...
      pad_and_copy_buffer(0x20,0xb76f,unaff_DS);
      create_bit_mask(puVar7,uVar8,uVar4);
    } while (((bool)uVar6) && (current_row - *(int *)0xb86e /* player_x */ != light_radius));
    cVar2 = check_inventory_has_item(0x11);
    if (cVar2 != '\0') {
      local_16 = *(int *)0xb86c /* player_y */ + 2;
      uVar5 = *(int *)0xb86c /* player_y */ - 2U;
      if ((int)(*(int *)0xb86c /* player_y */ - 2U) <= (int)local_16) {
        do {
          current_row = uVar5;
          local_18 = *(int *)0xb86e /* player_x */ + 2;
          iVar3 = *(int *)0xb86e /* player_x */ + -2;
          ...
          if (iVar3 <= local_18) {
            do {
              ...
              if (!(bool)uVar6) {
                ...
                create_bit_mask(puVar7,uVar8,uVar4);
                if (!(bool)uVar6) {
                  iVar3 = local_e - *(int *)0xb86c /* player_y */;
                  if (iVar3 < 0) {
                    iVar3 = -iVar3;
                  }
                  if (iVar3 < 2) {
                    iVar3 = local_c - *(int *)0xb86e /* player_x */;
                    if (iVar3 < 0) {
                      iVar3 = -iVar3;
                    }
...
LAB_1000_11a4:
    ...
    local_6 = *(int *)0xb86c /* player_y */ + local_6;
    local_4 = local_4 + *(int *)0xb86e /* player_x */;
    uVar6 = (undefined1)((uint)local_4 >> 8);
    if (*(char *)0xb8f6 /* is_wizard */ == '\0') {
...

{
  ...
  if ((((*(char *)0xb8f2 /* is_teleporting */ != '\0') || (*(char *)0xb8ee /* needs_full_update */ != '\0')) || (*(char *)0xb8ed /* is_blind */ != '\0')) ||
...
LAB_1000_1269:
  local_4 = 1;
  do {
    if (*(char *)(*(int *)0xe52d /* dungeon_level */ * 0x719 + local_6 * MAP_WIDTH + local_4 + 0x70d) == '\0') {
LAB_1000_132c:
      uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      if (*(char *)((int)uVar1 + 0x719) != '\0') {
        uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
        iVar3 = (int)uVar1 + local_6 * MAP_WIDTH + local_4;
        uVar4 = iVar3 == 0;
        uVar2 = CONCAT11((char)((uint)(local_6 * MAP_WIDTH) >> 8),*(undefined1 *)(iVar3 + -0x50));
        puVar7 = local_48;
        uVar8 = unaff_SS;
        pad_and_copy_buffer(0x20,0xb76f,unaff_DS);
        puVar5 = local_68;
      ...
      iVar3 = (int)uVar1 + local_6 * MAP_WIDTH + local_4;
      uVar4 = iVar3 == 0;
      uVar8 = CONCAT11((char)((uint)(local_6 * MAP_WIDTH) >> 8),*(undefined1 *)(iVar3 + -0x50));
      puVar7 = local_28;
      uVar6 = unaff_SS;
      zero_word_array_16(puVar7);
  ...
  if ((*(int *)((char *)param_3 + 3) == 1) ||
    ...
    *(int *)0xb8c4 = *(int *)0xb8c4 - *(int *)(local_6 + 0xb);
    if (param_2 == '\0') {
      ...
      prepend_item_to_list(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9,unaff_DS,&local_6,unaff_SS);
      *(undefined2 *)(local_6 + 5) = *(undefined2 *)0xb86c /* player_y */;
      *(undefined2 *)(local_6 + 7) = *(undefined2 *)0xb86e /* player_x */;
    ...
    *(int *)(pcVar5 + 3) = *(int *)(pcVar5 + 3) + -1;
    ...
    if (param_2 != '\0') {
      ...
      *(undefined2 *)((int)_local_6 + 3) = 1;
      ...
      iVar4 = (int)_local_6;
      *(undefined2 *)(iVar4 + 5) = *(undefined2 *)0xb86c /* player_y */;
      *(undefined2 *)(iVar4 + 7) = *(undefined2 *)0xb86e /* player_x */;
...

{
  ...
  if (((((((int)((ulong)*param_1 >> 0x10) == *(int *)0xb928) && ((int)*param_1 == *(int *)0xb926 /* equipped_shield */))
        || (((int)((ulong)*param_1 >> 0x10) == *(int *)0xb924 && ((int)*param_1 == *(int *)0xb922 /* wielded_weapon */)))
        ) || (((int)((ulong)*param_1 >> 0x10) == *(int *)0xb934 && ((int)*param_1 == *(int *)0xb932 /* equipped_ring2 */)
              ))) ||
      (((int)((ulong)*param_1 >> 0x10) == *(int *)0xb92c && ((int)*param_1 == *(int *)0xb92a /* equipped_armor */)))) ||
     (((int)((ulong)*param_1 >> 0x10) == *(int *)0xb930 && ((int)*param_1 == *(int *)0xb92e /* equipped_ring1 */)))) {
    local_4 = '\x01';
  }
  else {
    local_4 = '\0';
...

{
  ...
  local_4 = 0;
  local_6 = (int)((ulong)*(undefined4 *)0xb91e /* inventory_list */ >> 0x10);
  local_8 = (int)*(undefined4 *)0xb91e /* inventory_list */;
...

{
  ...
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
  uVar3 = (undefined2)((ulong)param_1 >> 0x10);
  piVar2 = (int *)param_1;
  *param_1 = (int)uVar1;
  piVar2[1] = (int)((ulong)uVar1 >> 0x10);
...

{
  ...
  while (iVar3 != 0 || local_c != 0) {
    ...
    *(undefined1 *)((int)uVar2 + *(int *)(iVar3 + 5) * MAP_WIDTH + *(int *)(iVar3 + 7) + -0x50) = uVar4;
...

{
  ...
  if (local_8 != 0 || local_6 != 0) {
    ...
    *(undefined2 *)(local_8 + 0x18) = (int)((ulong)uVar2 >> 0x10);
    uVar2 = *(undefined4 *)0xb91e /* inventory_list */;
...

{
  ...
  pcVar1 = (char *)*(undefined4 *)0xb91e /* inventory_list */;
  bVar3 = (byte)((ulong)pcVar1 >> 8);
  if (*(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 1) == 10) {
...

{
  ...
  iVar3 = (*(int *)0xb888 /* player_level */ + 2) / 2 >> 0xf;
  local_16 = combat_wrapper();
  local_38 = param_1;
  iVar4 = *(int *)0xb888 /* player_level */ + 1 + *(int *)0xb878 /* strength */ >> 0xf;
  local_14 = in_BX;
  local_12 = iVar3;
  ...
  iVar4 = (*(int *)0xb888 /* player_level */ * *(int *)0xb874 /* current_mana */) / 10 + 8 >> 0xf;
  local_30 = iVar3;
  uVar1 = combat_wrapper();
  ...
  local_2a = iVar3;
  uVar1 = combat_wrapper();
  iVar3 = (*(int *)0xb888 /* player_level */ + -1) / 2 + *(int *)0xb888 /* player_level */ >> 0xf;
  combat_wrapper(uVar1,in_BX,iVar4);
  ...
  iVar4 = *(int *)0xb888 /* player_level */ + -1 >> 0xf;
  combat_wrapper();
...

{
  ...
  pcVar1 = (char *)*(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5499);
...

{
  ...
  if ((bool)((byte)param_2 & 1)) {
    uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    *(undefined1 *)((int)uVar1 + param_2 * MAP_WIDTH + param_1 + -0x50) = 0x20;
  }
  else {
    uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    *(undefined1 *)((int)uVar1 + param_2 * MAP_WIDTH + param_1 + -0x50) = 0x20;
...

{
  ...
  *(undefined1 *)
  ...
  remove_item_from_list(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9,unaff_DS,&local_6,unaff_SS);
...

{
  ...
  uVar1 = (uint)*(byte *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 1);
  puVar3 = local_22;
...

{
  ...
  do {
    ...
    } while (*(char *)((int)uVar1 + *param_3 * MAP_WIDTH + *param_2 + -0x50) != ' ');
  } while (*(char *)(*param_3 * MAP_WIDTH + *param_2 + -0xc) != ' ');
  return;
}
    ...
    do {
      do {
        do {
          ...
          *param_1 = *(int *)0xb86e /* player_x */ + iVar6;
          in_DX = (undefined2)((ulong)*param_2 * MAP_WIDTH >> 0x10);
          uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
        } while (*(char *)((int)uVar2 + (int)((ulong)*param_2 * MAP_WIDTH) + *param_1 + -0x50) != ' ');
        lVar3 = (ulong)*param_2 * MAP_WIDTH;
...

{
  ...
  uVar1 = *(undefined4 *)(param_1 * 4 + 4);
  *(undefined1 *)((int)uVar1 + *(int *)(iVar2 + 5) * MAP_WIDTH + *(int *)(iVar2 + 7) + -0x50) = uVar3;
...

{
  ...
  *(undefined2 *)(pcVar3 + 0x14) = uVar4;
  ...
  uVar4 = (undefined2)((ulong)local_a >> 0x10);
  if ((!(bool)uVar6) &&
     (*(int *)(pcVar3 + 8) + *(int *)(pcVar3 + 0x14) < *(int *)0xb888 /* player_level */ + *(int *)0xb880 /* base_ac */ + 5)) {
    *(int *)(pcVar3 + 8) = *(int *)(pcVar3 + 8) + 1;
    *(int *)(pcVar3 + 0x14) = (*(int *)0xb888 /* player_level */ + *(int *)0xb880 /* base_ac */ + 6) - *(int *)(pcVar3 + 8);
  }
  ...
  *(undefined2 *)(pcVar3 + 0x1a) = *(undefined2 *)(param_2 * 0x2a + -0x4ff2);
  ...
  if (*(int *)(pcVar3 + 0x16) != 0) {
    ...
    if (iVar2 == 0) {
      initialize_monster_or_item(local_6,unaff_SS,*(undefined2 *)0xe52d /* dungeon_level */,((char *)local_a)[0x18]);
      uVar4 = (undefined2)((ulong)local_a >> 0x10);
...

{
  ...
  local_6 = 1;
  while( true ) {
    if ((*(int *)(*(int *)0xe52d /* dungeon_level */ * 2 + 0x797d) < 0x19) &&
       (local_4 = *(int *)(local_6 * 0x20 + *(int *)0xe52d /* dungeon_level */ * 2 + -0x546d), local_4 != 0)) {
      ...
      if ((bool)uVar7) {
        ...
        *(int *)(pbVar6 + 0x34) = (int)((ulong)uVar1 >> 0x10);
        iVar5 = *(int *)0xe52d /* dungeon_level */ * 4;
        uVar7 = iVar5 == 0;
        ...
        *(undefined2 *)(iVar5 + -0x5497) = uVar3;
        ...
        if (!(bool)uVar7) {
          *(int *)(*(int *)0xe52d /* dungeon_level */ * 2 + 0x799b) = *(int *)(*(int *)0xe52d /* dungeon_level */ * 2 + 0x799b) + 1;
        }
        *(int *)(*(int *)0xe52d /* dungeon_level */ * 2 + 0x797d) = *(int *)(*(int *)0xe52d /* dungeon_level */ * 2 + 0x797d) + 1;
      }
    }
  ...
  *(int *)(param_1 + -2) = iVar2 + 1;
  if (*(int *)(param_1 + -2) < 0x187) {
    ...
    *(int *)(param_1 + -6) = (*(int *)(param_1 + -2) + -1) % 0x27 + 1;
    iVar2 = (*(int *)(param_1 + -8) * 2 + 1) * MAP_WIDTH;
    ...
    if (!(bool)uVar6) {
      ...
      *(undefined2 *)(param_1 + -10) = uVar4;
      if ((*(int *)(param_1 + -0xc) != *(int *)(param_1 + -10)) ||
        ...
        uVar1 = *(undefined4 *)(*(int *)(param_1 + 4) * 4 + 4);
        *(undefined1 *)
         ((int)uVar1 + (*(int *)(param_1 + -8) * 2 + 1) * MAP_WIDTH + *(int *)(param_1 + -6) * 2 + -0x50)
             = 0x20;
...

{
  ...
  do {
    ...
    *(int *)(param_1 * 4 + 0x78ef) = iVar2 * 2 + 2;
    uVar1 = *(undefined4 *)(param_1 * 4 + 4);
  } while (*(char *)((int)uVar1 + *(int *)(param_1 * 4 + 0x78ed) * MAP_WIDTH +
                     *(int *)(param_1 * 4 + 0x78ef) + -0x50) != ' ');
  uVar1 = *(undefined4 *)(param_1 * 4 + 4);
  *(undefined1 *)
   ((int)uVar1 + *(int *)(param_1 * 4 + 0x78ed) * MAP_WIDTH + *(int *)(param_1 * 4 + 0x78ef) + -0x50) =
       0xef;
  do {
    iVar2 = random_mod(10);
    ...
    *(int *)(param_1 * 4 + 0x792f) = iVar2 * 2 + 2;
    uVar1 = *(undefined4 *)(param_1 * 4 + 4);
  } while (*(char *)((int)uVar1 + *(int *)(param_1 * 4 + 0x792d) * MAP_WIDTH +
                     *(int *)(param_1 * 4 + 0x792f) + -0x50) != ' ');
  if (param_1 != 0xf) {
    uVar1 = *(undefined4 *)(param_1 * 4 + 4);
    *(undefined1 *)
     ((int)uVar1 + *(int *)(param_1 * 4 + 0x792d) * MAP_WIDTH + *(int *)(param_1 * 4 + 0x792f) + -0x50) =
         0xef;
  }
  iVar2 = param_1 >> 0xf;
  combat_wrapper();
...

{
  ...
  *(undefined2 *)0xb886 /* experience */ = 0;
  *(undefined2 *)0xb888 /* player_level */ = 0x80;
  *(undefined2 *)0xb870 /* current_hp */ = 1000;
  *(undefined2 *)0xb872 /* max_hp */ = 1000;
  *(undefined2 *)0xb88a = 0;
  *(undefined2 *)0xb88c = 0;
  *(undefined2 *)0xb88e = 0;
  clear_screen_double();
  ...
  if (cVar3 == 'O') {
    *(undefined2 *)0xb874 /* current_mana */ = 100;
    *(undefined2 *)0xb876 /* max_mana */ = 100;
    *(undefined2 *)0xb878 /* strength */ = 100;
    *(undefined2 *)0xb87a /* intelligence */ = 100;
  }
  else {
    clear_screen_double();
    uVar7 = 0xe654;
    ...
    *(undefined2 *)0xb876 /* max_mana */ = uVar4;
    read_line(0x214c);
    *(undefined2 *)0xb874 /* current_mana */ = *(undefined2 *)0xb876 /* max_mana */;
    iVar5 = 0xff - *(int *)0xb876 /* max_mana */;
    ...
    uVar4 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb878 /* strength */ = uVar4;
    read_line(0x214c);
    iVar5 = iVar5 - *(int *)0xb878 /* strength */;
    uVar6 = (undefined1)((uint)iVar5 >> 8);
    validate_window_coords(CONCAT11(uVar6,1),CONCAT11(uVar6,0xb));
    uVar7 = 0xe654;
    uVar4 = unaff_DS;
  ...
  *(undefined1 *)0xb8f4 = 1;
  *(undefined1 *)0xb915 /* is_dying */ = 0;
  *(undefined1 *)0xb916 /* is_hasted */ = 0;
  *(undefined1 *)0xb917 = 0;
  *(undefined1 *)0xb918 /* has_light */ = 0;
  *(undefined1 *)0xb919 /* is_confused */ = 0;
  *(undefined2 *)0xb890 = 5;
  allocate_item_object(0xb91e,unaff_DS);
  puVar1 = (undefined1 *)*(undefined4 *)0xb91e /* inventory_list */;
  uVar4 = (undefined2)((ulong)puVar1 >> 0x10);
...

{
  ...
  for (local_4 = 1; (local_9 != '\0' && (local_4 != 5)); local_4 = local_4 + 1) {
    ...
    do {
      ...
      uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      iVar3 = (int)uVar1 + local_8 * MAP_WIDTH + local_6;
      uVar4 = iVar3 == 0;
      uVar2 = CONCAT11((char)((uint)(local_8 * MAP_WIDTH) >> 8),*(undefined1 *)(iVar3 + -0x50));
      puVar7 = local_49;
      uVar8 = unaff_SS;
      pad_and_copy_buffer(0x20,0xb76f,unaff_DS);
      puVar5 = local_29;
...

{
  ...
  if (param_1 == '\0') {
    iVar5 = random_mod(5);
    initialize_monster_or_item(local_6,unaff_SS,*(undefined2 *)0xe52d /* dungeon_level */,iVar5 + 1);
    place_object_on_map(*(undefined2 *)0xe52d /* dungeon_level */,local_6,unaff_SS);
  }
  else {
    initialize_monster_or_item(local_a,unaff_SS,*(undefined2 *)0xe52d /* dungeon_level */,in_AX & 0xff00);
    place_object_on_map(*(undefined2 *)0xe52d /* dungeon_level */,local_a,unaff_SS);
  }
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
  uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
  uVar3 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
  *(undefined1 *)((int)uVar3 + *(int *)((int)uVar2 + 5) * MAP_WIDTH + *(int *)((int)uVar1 + 7) + -0x50) =
       0x20;
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
  *(undefined2 *)((int)uVar1 + 5) = *(undefined2 *)0xb86c /* player_y */;
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
  *(undefined2 *)((int)uVar1 + 7) = *(undefined2 *)0xb86e /* player_x */;
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
  uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
  ...
  iVar5 = (int)uVar1;
  uVar4 = lookup_table_b9c7(*(undefined2 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9),
                        *(undefined2 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d7));
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
  *(undefined1 *)((int)uVar1 + *(int *)(iVar5 + 5) * MAP_WIDTH + *(int *)(iVar5 + 7) + -0x50) = uVar4;
  return;
}
...

{
  ...
  uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5499);
...

{
  ...
  pcVar1 = (char *)*(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
  while (local_6 = (char *)pcVar1, local_4 = (int)((ulong)pcVar1 >> 0x10),
        local_6 != (char *)0x0 || local_4 != 0) {
    if (*pcVar1 == param_2) {
      if (*(char *)0xb8ee /* needs_full_update */ == '\0') {
        *(undefined1 *)
         (*(int *)0xe52d /* dungeon_level */ * 0x719 + *(int *)(local_6 + 5) * MAP_WIDTH + *(int *)(local_6 + 7) + 0x70d) = 1
        ;
      }
...

{
  ...
  local_6 = 1;
  while( true ) {
    put_char_at_pos(local_6 % 2 + 1,*(undefined2 *)0xb86e /* player_x */,*(undefined2 *)0xb86c /* player_y */);
    local_4 = 1;
    while( true ) {
...
LAB_1000_5755:
  if ((((((iVar3 == *(int *)0xb924) && (pcVar5 == (char *)*(undefined2 *)0xb922 /* wielded_weapon */)) ||
        ((iVar3 == *(int *)0xb928 && (pcVar5 == (char *)*(undefined2 *)0xb926 /* equipped_shield */)))) ||
       ((iVar3 == *(int *)0xb92c && (pcVar5 == (char *)*(undefined2 *)0xb92a /* equipped_armor */)))) ||
      ((iVar3 == *(int *)0xb934 && (pcVar5 == (char *)*(undefined2 *)0xb932 /* equipped_ring2 */)))) ||
     ((iVar3 == *(int *)0xb930 && (pcVar5 == (char *)*(undefined2 *)0xb92e /* equipped_ring1 */)))) {
...

{
  ...
  local_4 = (uint)((ulong)*(undefined4 *)0xb91e /* inventory_list */ >> 0x10);
  local_6 = (uint)*(undefined4 *)0xb91e /* inventory_list */;
...

{
  ...
  clear_screen_double();
  local_6 = (char *)*(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
  while( true ) {
...

{
  ...
  if (cVar1 == 'v') {
    uVar4 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb870 /* current_hp */ = uVar4;
    read_line(0x214c);
  }
  else if (cVar1 == 'm') {
    uVar4 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb872 /* max_hp */ = uVar4;
    read_line(0x214c);
  }
  else if (cVar1 == 'e') {
    uVar4 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb888 /* player_level */ = uVar4;
    read_line(0x214c);
  }
  else if (cVar1 == 'x') {
    uVar4 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb886 /* experience */ = uVar4;
    read_line(0x214c);
  }
  else if (cVar1 == 'f') {
    uVar4 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb874 /* current_mana */ = uVar4;
    read_line(0x214c);
  }
  else if (cVar1 == 's') {
    uVar4 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb909 = uVar4;
    ...
    uVar4 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb880 /* base_ac */ = uVar4;
    read_line(0x214c);
  }
  else if (cVar1 == 'd') {
    uVar4 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb878 /* strength */ = uVar4;
    ...
    uVar4 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb87a /* intelligence */ = uVar4;
    read_line(0x214c);
  }
  else if (cVar1 == 'o') {
    uVar2 = read_token_and_parse_number(0xe554);
    *(undefined2 *)0xb8c8 /* gold_low */ = uVar2;
    *(undefined2 *)0xb8ca /* gold_high */ = uVar4;
    read_line(0x214c);
  }
...

{
  ...
  while( true ) {
    ...
    while( true ) {
      uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      if (*(char *)((int)uVar1 + local_8 * MAP_WIDTH + local_6 + -0x50) != ' ') {
        validate_window_coords(local_8 + 1,CONCAT11((char)((uint)(local_8 * MAP_WIDTH) >> 8),(undefined1)local_6))
        ;
        uVar2 = 0xe654;
        uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
        uVar3 = unaff_DS;
        write_bytes(0,CONCAT11((char)((uint)(local_8 * MAP_WIDTH) >> 8),
                                 *(undefined1 *)((int)uVar1 + local_8 * MAP_WIDTH + local_6 + -0x50)));
        flush_output(uVar2,uVar3);
      }
...

{
  ...
  while( true ) {
    ...
    if ((*pcVar1 == '\b') && (*(int *)(local_a + 1) != 0)) {
      uVar2 = *(undefined4 *)0xb8c8 /* gold_low */;
      uVar4 = (uint)uVar2;
      uVar5 = *(uint *)(local_a + 0xd);
      iVar6 = *(int *)(local_a + 0xf);
      *(int *)0xb8c8 /* gold_low */ = uVar4 + *(uint *)(local_a + 0xd);
      *(int *)0xb8ca /* gold_high */ = (int)((ulong)uVar2 >> 0x10) + iVar6 + (uint)CARRY2(uVar4,uVar5);
    }
  ...
  if ((bool)uVar7) {
    ...
    write_padded_number(0,*(int *)0xe52d /* dungeon_level */,*(int *)0xe52d /* dungeon_level */ >> 0xf);
  ...
  if ((char)param_2 != 'Q') {
    ...
    if ((char)param_2 == 'g') {
      for (; local_6 < 0x10; local_6 = local_6 + 1) {
        ...
        if (((iVar6 <= *(int *)0xb8ca /* gold_high */) &&
            ((iVar6 < *(int *)0xb8ca /* gold_high */ || ((uint)uVar2 <= *(uint *)0xb8c8 /* gold_low */)))) ||
      ...
      for (; local_6 < 0x10; local_6 = local_6 + 1) {
        ...
        iVar6 = (int)((ulong)uVar2 >> 0x10);
        if ((iVar6 <= *(int *)0xb8ca /* gold_high */) &&
           ((iVar6 < *(int *)0xb8ca /* gold_high */ || ((uint)uVar2 <= *(uint *)0xb8c8 /* gold_low */)))) break;
      }
    }
    ...
    if (local_6 < 0x10) {
      ...
      *(undefined2 *)(iVar6 + -0x45cb) = *(undefined2 *)0xe52d /* dungeon_level */;
...

{
  ...
  puVar1 = (undefined1 *)*(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5499);
  while( true ) {
  ...
  *(undefined2 *)(*(int *)0xe52d /* dungeon_level */ * 2 + 0x799b) = 4;
  return;
}
...

{
  ...
  if (*(int *)0xb888 /* player_level */ < 0xe) {
    handle_error_and_wait();
    check_minimum_stats();
    *(int *)0xb888 /* player_level */ = *(int *)0xb888 /* player_level */ + 1;
    ...
    write_padded_number(0,*(int *)0xb888 /* player_level */,*(int *)0xb888 /* player_level */ >> 0xf);
    flush_output(uVar4,uVar5);
    uVar1 = random_mod(*(undefined2 *)0xe52d /* dungeon_level */);
    uVar1 = uVar1 / 2;
    iVar2 = random_mod(*(undefined2 *)0xb888 /* player_level */);
    iVar3 = random_mod(6);
    *(int *)0xb872 /* max_hp */ = *(int *)0xb872 /* max_hp */ + iVar3 + iVar2 + 3 + uVar1;
    iVar2 = random_mod(*(int *)0xb888 /* player_level */ + 6 + *(int *)0xe52d /* dungeon_level */);
    *(int *)0xb870 /* current_hp */ = *(int *)0xb870 /* current_hp */ + 1 + iVar2;
    if (*(int *)0xb872 /* max_hp */ < *(int *)0xb870 /* current_hp */) {
      *(undefined2 *)0xb870 /* current_hp */ = *(undefined2 *)0xb872 /* max_hp */;
    }
    display_character_stats();
  }
  return;
...

{
  ...
  if (*(int *)0xb888 /* player_level */ != 1) {
    *(int *)0xb888 /* player_level */ = *(int *)0xb888 /* player_level */ + -1;
  }
  iVar1 = random_mod(*(int *)0xb888 /* player_level */ + 6);
  *(int *)0xb872 /* max_hp */ = (*(int *)0xb872 /* max_hp */ + -3) - iVar1;
  if (*(int *)0xb872 /* max_hp */ < *(int *)0xb870 /* current_hp */) {
    *(undefined2 *)0xb870 /* current_hp */ = *(undefined2 *)0xb872 /* max_hp */;
  }
  return;
...

{
  ...
  if ((*(uint *)0xb926 /* equipped_shield */ | *(uint *)0xb928) == 0) {
    return;
  }
  uVar5 = *(int *)0xb87c == 1;
  if (*(int *)0xb87c < 2) {
  ...
  uVar3 = CONCAT11((char)((*(uint *)0xb926 /* equipped_shield */ | *(uint *)0xb928) >> 8),
                   *(undefined1 *)((int)*(undefined4 *)0xb926 /* equipped_shield */ + 1));
  puVar6 = local_22;
  zero_word_array_16(puVar6);
  ...
  uVar3 = (undefined2)((ulong)*(undefined4 *)0xb926 /* equipped_shield */ >> 0x10);
  iVar1 = (int)*(undefined4 *)0xb926 /* equipped_shield */;
...
LAB_1000_78e1:
  ...
  *(int *)0xb880 /* base_ac */ = *(int *)0xb880 /* base_ac */ + -1;
  display_character_stats();
  return;
}
...

{
  ...
  if (*(int *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5499) != 0 || *(int *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5497) != 0) {
    uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5499);
    uVar3 = (undefined2)((ulong)uVar1 >> 0x10);
    iVar2 = (int)uVar1;
    *(undefined1 *)(*(int *)(iVar2 + 0x1c) * MAP_WIDTH + *(int *)(iVar2 + 0x1e) + -0xc) = 0x20;
    *(undefined2 *)(iVar2 + 0x1c) = *(undefined2 *)0xb86c /* player_y */;
    *(undefined2 *)(iVar2 + 0x1e) = *(undefined2 *)0xb86e /* player_x */;
    do {
...

{
  ...
  if (param_1 != '\0') {
    ...
    if (*(int *)(pcVar10 + 0x2e) == 0 && *(int *)(pcVar10 + 0x30) == 0) {
      ...
      *(undefined2 *)((int)*(undefined4 *)(pcVar10 + 0x2e) + 5) = *(undefined2 *)0xb86c /* player_y */;
      *(undefined2 *)((int)*(undefined4 *)(pcVar10 + 0x2e) + 7) = *(undefined2 *)0xb86e /* player_x */;
      ...
      uVar4 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      *(undefined1 *)
       ((int)uVar4 + *(int *)((int)*(undefined4 *)(pcVar10 + 0x2e) + 5) * MAP_WIDTH +
        *(int *)((int)*(undefined4 *)(pcVar10 + 0x2e) + 7) + -0x50) = uVar12;
      prepend_item_to_list(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9,unaff_DS,pcVar10 + 0x2e,iVar11);
      bVar8 = extraout_AH;
    }
    cVar2 = *param_2;
    if (cVar2 == 'V') {
  ...
  *(undefined1 *)(iVar9 * MAP_WIDTH + *(int *)(pcVar10 + 0x1e) + -0xc) = 0x20;
  put_char_at_pos(CONCAT11((char)((uint)(iVar9 * MAP_WIDTH) >> 8),0x20),*(undefined2 *)(pcVar10 + 0x1e),
  ...
  if (param_1 != '\0') {
    ...
    *(int *)(pcVar10 + 6) = *(int *)(pcVar10 + 6) + iVar9;
    iVar9 = *(int *)(*(int *)0xb888 /* player_level */ * 2 + -0x46b8) - *(int *)((*(int *)0xb888 /* player_level */ + -1) * 2 + -0x46b8)
            >> 0xf;
    combat_wrapper();
    uVar12 = 0;
    uVar13 = 1;
    ...
    if (!(bool)uVar12 && !(bool)uVar13) {
      *(int *)(pcVar10 + 6) =
           (*(int *)(*(int *)0xb888 /* player_level */ * 2 + -0x46b8) - *(int *)((*(int *)0xb888 /* player_level */ + -1) * 2 + -0x46b8))
           / 2;
    }
    iVar9 = combat_check_with_error();
    *(int *)0xb886 /* experience */ = *(int *)0xb886 /* experience */ + *(int *)(pcVar10 + 6) + iVar9;
    ...
    *(undefined2 *)0xb88e = uVar6;
    if (*(int *)0xb886 /* experience */ < 0) {
      *(undefined2 *)0xb886 /* experience */ = 0;
    }
    if (*(int *)(*(int *)0xb888 /* player_level */ * 2 + -0x46b8) <= *(int *)0xb886 /* experience */) {
      level_up_character();
    }
...

{
  ...
  if ((*(char *)0xb8ed /* is_blind */ == '\0') && (*(char *)0xb8f0 /* confusion_lock */ == '\0')) {
    display_score_with_fatal(0x93);
    *(int *)0xb87a /* intelligence */ = *(int *)0xb87a /* intelligence */ + -5;
    handle_error_and_wait();
  }
...

{
  ...
  local_8 = (int)((ulong)*(undefined4 *)0xb91e /* inventory_list */ >> 0x10);
  local_a = (undefined1 *)(undefined1 *)*(undefined4 *)0xb91e /* inventory_list */;
...
void monster_attack_player(undefined2 monster_x,undefined2 monster_y,undefined4 param_3,undefined4 *monster_ptr)

{
  ...
  to_hit_roll = ((*(int *)((int)*monster_ptr + 8) - *(int *)0xb888 /* player_level */) - *(int *)0xb880 /* base_ac */) + 1 + iVar8;
  if (*(char *)0xb8f7 /* is_stunned */ != '\0') {
  ...
  if (uVar9 != 0) {
    iVar8 = random_mod(5);
    uVar9 = to_hit_roll + 1 + iVar8;
    to_hit_roll = uVar9;
  }
  uVar10 = (undefined1)(uVar9 >> 8);
  if ((int)to_hit_roll < 1) {
    if (*(char *)0xb8ed /* is_blind */ == '\0') {
      display_class_info(CONCAT11(uVar10,1),*(undefined2 *)((int)*monster_ptr + 4));
    }
    else {
      uVar15 = 0xe654;
      uVar16 = unaff_DS;
  ...
  if (*(int *)(pbVar5 + 0x10) != 0) {
    ...
    if (0 < (int)num_attacks) {
      ...
      while( true ) {
        ...
        *(int *)0xb870 /* current_hp */ = (*(int *)0xb870 /* current_hp */ + -1) - iVar8;
        uVar9 = damage;
  ...
  if (*(int *)0xb870 /* current_hp */ < 1) {
    ...
    iVar8 = random_mod(6);
    *(int *)0xb870 /* current_hp */ = (*(int *)0xb872 /* max_hp */ + -5) - iVar8;
    *(undefined2 *)0xb872 /* max_hp */ = *(undefined2 *)0xb870 /* current_hp */;
    *(int *)0xb876 /* max_mana */ = *(int *)0xb876 /* max_mana */ + -2;
    *(int *)0xb874 /* current_mana */ = *(int *)0xb874 /* current_mana */ + -2;
    *(int *)0xb87a /* intelligence */ = *(int *)0xb87a /* intelligence */ + -1;
  ...
  attack_type = *pbVar2;
  if ((attack_type == 0xea) || (attack_type == 0xe8)) {
    *(undefined1 *)0xb8ec /* is_paralyzed */ = 0;
    goto LAB_1000_850d;
  }
  if (attack_type == 0x4d) {
  ...
  uVar10 = attack_type < 0x9c;
  uVar12 = attack_type == 0x9c;
  if ((bool)uVar12) {
    find_highest_bit();
    char_create_wrapper();
    if (!(bool)uVar10 && !(bool)uVar12) {
      *(int *)0xb878 /* strength */ = *(int *)0xb878 /* strength */ + -1;
      display_score_with_fatal(199);
    }
    goto LAB_1000_850d;
  }
  if ((attack_type == 0x47) || (attack_type == 0x4e)) {
    if (*pbVar2 == 0x47) {
      find_highest_bit();
      bVar11 = false;
      bVar13 = true;
  ...
  if ((bool)uVar12) {
    ...
    if (!(bool)uVar10 && !(bool)uVar12) {
      iVar8 = random_mod(10);
      *(int *)0xb886 /* experience */ = (*(int *)0xb886 /* experience */ + -10) - iVar8;
      if (*(int *)0xb886 /* experience */ < *(int *)((*(int *)0xb888 /* player_level */ + -1) * 2 + -0x46b8)) {
  ...
  if (bVar7 == 0x45) {
    ...
    if ((int)local_f < 4) {
      pbVar5[0x22] = 0;
      pbVar5[0x28] = 1;
      *(undefined1 *)0xb915 /* is_dying */ = 1;
      handle_error_and_wait();
      check_minimum_stats();
      if (local_f == 3) {
        display_score_with_fatal(0x3e);
        iVar8 = random_mod(0x32);
        *(int *)0xb91a /* death_timer */ = iVar8 + 100;
      }
      else {
        display_score_with_fatal(0x49);
        iVar8 = random_mod(5);
        *(int *)0xb91a /* death_timer */ = iVar8 + 0xf;
      }
    }
    goto LAB_1000_850d;
  }
  if (bVar7 == 0x48) {
    *(undefined1 *)0xb919 /* is_confused */ = 1;
    goto LAB_1000_850d;
  }
  if (bVar7 != 0x46) {
    if (bVar7 == 0x56) {
      ...
      if ((*(int *)0xb8ca /* gold_high */ < (int)local_f >> 0xf) ||
         ((*(int *)0xb8ca /* gold_high */ <= (int)local_f >> 0xf && (*(uint *)0xb8c8 /* gold_low */ < local_f)))) {
        local_f = *(uint *)0xb8c8 /* gold_low */;
      }
      uVar4 = *(undefined4 *)0xb8c8 /* gold_low */;
      uVar9 = (uint)uVar4;
      *(int *)0xb8c8 /* gold_low */ = uVar9 - local_f;
      *(int *)0xb8ca /* gold_high */ =
  ...
  local_d = 0;
  local_19[1] = 0;
  if (*(int *)0xb91e /* inventory_list */ != 0 || *(int *)0xb920 != 0) {
    if ((*(int *)0xb926 /* equipped_shield */ != 0 || *(int *)0xb928 != 0) &&
       (*(char *)((int)*(undefined4 *)0xb926 /* equipped_shield */ + 0x14) == '\0')) {
      uVar9 = *(uint *)((int)*(undefined4 *)0xb926 /* equipped_shield */ + 1);
      uVar10 = uVar9 < 6;
      uVar12 = uVar9 == 6;
      if ((bool)uVar12) {
        find_highest_bit();
        char_create_wrapper();
        if (!(bool)uVar10 && !(bool)uVar12) {
          local_13 = (char *)*(undefined4 *)0xb926 /* equipped_shield */;
    ...
    do {
      ...
      *(int *)(pbVar5 + 4) = iVar8 + 1;
      local_13 = (char *)*(undefined4 *)0xb91e /* inventory_list */;
      iVar8 = *(int *)(pbVar5 + 4) - *(int *)((int)*(undefined4 *)0xb91e /* inventory_list */ + 3);
      *(int *)(pbVar5 + 4) = iVar8;
...
LAB_1000_83ad:
  if ((*(int *)0xb91e /* inventory_list */ != 0 || *(int *)0xb920 != 0) && (local_d != 10)) {
    handle_error_and_wait();
    check_minimum_stats();
    if (*(char *)0xb8ed /* is_blind */ == '\0') {
      uVar15 = 0xe654;
    ...
    flush_output(uVar15,uVar16);
    if ((*local_13 == '\b') && (*(undefined1 *)0xb918 /* has_light */ = 0, *(int *)0xe52d /* dungeon_level */ == 1)) {
      uVar4 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      *(undefined1 *)((int)uVar4 + *(int *)0x78f1 * MAP_WIDTH + *(int *)0x78f3 + -0x50) = 0x20;
    }
    cleanup_after_monster_death(&stack0xfffe);
...

{
  ...
  if ((byte *)local_6 == (byte *)0x0 && local_6._2_2_ == 0) {
    ...
    local_15 = *(int *)0xb878 /* strength */;
    if (local_15 == 0) {
      local_15 = 1;
    }
    if (*(int *)0xb92e /* equipped_ring1 */ != 0 || *(int *)0xb930 != 0) {
      if (*(int *)((int)*(undefined4 *)0xb92e /* equipped_ring1 */ + 1) == 9) {
        local_15 = local_15 + 2;
      }
      else if ((*(int *)((int)*(undefined4 *)0xb92e /* equipped_ring1 */ + 1) == 10) &&
              (local_15 = local_15 + -4, local_15 < 1)) {
        local_15 = 1;
      }
    }
    if (*(int *)0xb922 /* wielded_weapon */ == 0 && *(int *)0xb924 == 0) {
      local_12 = random_mod(local_15);
      uVar14 = 0;
      uVar10 = (undefined2)((ulong)local_6 >> 0x10);
      local_12 = ((*(int *)0xb888 /* player_level */ - *(int *)((byte *)local_6 + 8)) - *(int *)((byte *)local_6 + 0xc)
                 ) + 1 + local_12;
    }
    else {
      ...
      uVar14 = 0;
      uVar10 = (undefined2)((ulong)local_6 >> 0x10);
      uVar6 = (((*(int *)0xb888 /* player_level */ + *(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 9)) -
               *(int *)((byte *)local_6 + 8)) - *(int *)((byte *)local_6 + 0xc)) + 1;
      local_12 = uVar6 + uVar5;
      uVar11 = ((int)uVar6 >> 0xf) + (uint)CARRY2(uVar6,uVar5) == 0;
      uVar8 = CONCAT11((char)((uint)local_12 >> 8),*(undefined1 *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 1));
      puVar13 = local_3b;
      uVar10 = unaff_SS;
    ...
    if (local_12 < 1) {
      ...
      local_10 = 0;
      if (*(int *)0xb874 /* current_mana */ < ITEM_SIZE) {
        local_17 = *(int *)0xb874 /* current_mana */;
      }
      else {
        local_17 = 0x19;
      }
      if ((*(int *)0xb92e /* equipped_ring1 */ != 0 || *(int *)0xb930 != 0) &&
         (*(int *)((int)*(undefined4 *)0xb92e /* equipped_ring1 */ + 1) == 0xb)) {
        local_17 = local_17 + 2;
      }
      if (-1 < *(int *)0xb882) {
        local_10 = random_mod(*(int *)0xb882 + 1 + (*(int *)0xb888 /* player_level */ * local_17) / 10);
        local_10 = local_10 + 1;
      }
        ...
        *(undefined1 *)0xb8ec /* is_paralyzed */ = 0;
        if ((*local_1f == 0xea) && (uVar11 = pbVar9[0x22] == 0, !(bool)uVar11)) {
          uVar10 = CONCAT11((char)((uint)local_e >> 8),
                            *(undefined1 *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 1));
          puVar13 = local_3f;
          uVar14 = unaff_SS;
          zero_word_array_16(puVar13);
          ...
          if (!(bool)uVar11) {
            ...
            if (*(int *)(pbVar9 + 0x2e) != 0 || *(int *)(pbVar9 + 0x30) != 0) {
              *(undefined2 *)((int)*(undefined4 *)(pbVar9 + 0x2e) + 5) = *(undefined2 *)0xb86c /* player_y */;
              *(undefined2 *)((int)*(undefined4 *)(pbVar9 + 0x2e) + 7) = *(undefined2 *)0xb86e /* player_x */;
              ...
              *(undefined1 *)
              ...
              prepend_item_to_list(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9,unaff_DS,pbVar9 + 0x2e,uVar14);
              uVar14 = (undefined2)((ulong)local_1f >> 0x10);
        ...
        if (*(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 9) < 5) {
          local_10 = 2;
        }
      }
      else if (bVar2 == 1) {
        if (((*(int *)(pbVar9 + 10) < 0x28) && (**(char **)(pbVar9 + 0x2e) == '\x04')) &&
          ...
          *(byte *)(*(int *)(pbVar9 + 0x1c) * MAP_WIDTH + *(int *)(pbVar9 + 0x1e) + -0xc) = pbVar9[1];
          pbVar9[0x23] = 0;
          if (*(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 9) < 3) {
            local_10 = 1;
          }
        }
      }
        ...
        if ((bool)uVar11) {
            ...
            *(byte *)(*(int *)(pbVar9 + 0x1c) * MAP_WIDTH + *(int *)(pbVar9 + 0x1e) + -0xc) = pbVar9[1];
            ...
            if (iVar7 == 0) {
              ...
              *(undefined1 *)0xb916 /* is_hasted */ = 1;
              iVar7 = random_mod(6);
              *(int *)0xb91c /* haste_timer */ = iVar7 + 5;
            }
            else if (iVar7 == 2) {
              *(undefined1 *)0xb8f2 /* is_teleporting */ = 1;
              iVar7 = random_mod(10);
              *(int *)0xb905 = iVar7 + 10;
              clear_screen_double();
            }
            else if (iVar7 == 3) {
              *(undefined1 *)0xb8ed /* is_blind */ = 1;
              iVar7 = random_mod(6);
              *(int *)0xb8fb = iVar7 + 5;
            }
            else if (iVar7 == 4) {
              clear_screen_double();
              display_character_stats();
              *(undefined1 *)0xb8ee /* needs_full_update */ = 1;
              ...
              *(undefined1 *)((int)uVar3 + 0x719) = 0;
              ...
              while( true ) {
                for (local_19 = 1;
                    *(undefined1 *)(*(int *)0xe52d /* dungeon_level */ * 0x719 + local_1b * MAP_WIDTH + local_19 + 0x70d) = 0
          ...
          if (*(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 9) < 4) {
            local_10 = 1;
          }
        }
      }
        ...
        if (*(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 1) == 0xe) {
          *(int *)(pbVar9 + 10) = *(int *)(pbVar9 + 10) - local_10;
        }
      }
      else if (bVar2 == 0x73) {
        ...
        if (!(bool)uVar11 && !(bool)uVar12) {
          ...
          *(int *)0xb870 /* current_hp */ = *(int *)0xb870 /* current_hp */ - local_12;
          display_character_stats();
          if (*(int *)0xb870 /* current_hp */ < 1) {
      ...
      *(int *)((byte *)local_1f + 10) = *(int *)((byte *)local_1f + 10) - local_10;
      if ((*(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 1) == 0xf) &&
         (iVar7 = random_mod(4), iVar7 == 0)) {
        *(int *)0xb870 /* current_hp */ = local_10 / 2 + *(int *)0xb870 /* current_hp */;
        if (*(int *)0xb872 /* max_hp */ < *(int *)0xb870 /* current_hp */) {
          *(undefined2 *)0xb870 /* current_hp */ = *(undefined2 *)0xb872 /* max_hp */;
        }
        display_character_stats();
...

{
  ...
  *(int *)0xb878 /* strength */ = *(int *)0xb878 /* strength */ + -2;
  iVar1 = *(int *)0xb936;
  local_4 = param_1 + 1;
  if (local_4 <= iVar1) {
    while( true ) {
...

{
  ...
  *(undefined2 *)0xb870 /* current_hp */ = uVar6;
  combat_wrapper();
  check_combat_and_handle_error();
  combat_check_with_error();
  uVar6 = validate_range_bounds();
  *(undefined2 *)0xb872 /* max_hp */ = uVar6;
  uVar6 = validate_range_bounds();
  *(undefined2 *)0xb874 /* current_mana */ = uVar6;
  uVar6 = validate_range_bounds();
  *(undefined2 *)0xb876 /* max_mana */ = uVar6;
  ...
  if (*(int *)0xb874 /* current_mana */ < 0) {
    *(undefined2 *)0xb874 /* current_mana */ = 0;
  }
  display_character_stats();
...

{
  ...
  if (*local_11 == '\0') {
    uVar5 = *(uint *)(pcVar7 + 9);
    uVar1 = *(uint *)0xb8c8 /* gold_low */;
    iVar6 = *(int *)0xb8ca /* gold_high */;
    *(int *)0xb8c8 /* gold_low */ = uVar5 + *(uint *)0xb8c8 /* gold_low */;
    *(int *)0xb8ca /* gold_high */ = ((int)uVar5 >> 0xf) + iVar6 + (uint)CARRY2(uVar5,uVar1);
    remove_item_from_list(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9,unaff_DS,&local_11,unaff_SS);
    free_item_object((char *)local_11,local_11._2_2_);
    uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    *(undefined1 *)((int)uVar2 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */ + -0x50) = 0x20;
    display_character_stats();
    return;
  }
...
LAB_1000_9184:
  if ((local_13 == '\0') || (local_12 != '\0')) {
    ...
    *(undefined1 *)((int)uVar2 + *(int *)(pcVar7 + 5) * MAP_WIDTH + *(int *)(pcVar7 + 7) + -0x50) = 0x20;
    ...
    pcVar3 = (char *)*(undefined4 *)0xb91e /* inventory_list */;
    local_14 = '\0';
    local_5 = 1;
    while( true ) {
...
LAB_1000_9300:
    ...
    if (local_14 == '\0') {
      local_d = (char *)*(undefined4 *)0xb91e /* inventory_list */;
      *(int *)0xb8c2 = *(int *)0xb8c2 + 1;
      pcVar7 = (char *)local_11;
      uVar9 = (undefined2)((ulong)local_11 >> 0x10);
      if (((char *)local_d == (char *)0x0 && (int)((ulong)local_d >> 0x10) == 0) ||
        ...
        *(undefined2 *)0xb91e /* inventory_list */ = pcVar7;
...

{
  ...
  if (0 < iVar8) {
    ...
    while( true ) {
      ...
      iVar8 = (int)uVar1 >> 0xf;
      if (((iVar8 < *(int *)0xb8ca /* gold_high */) || ((iVar8 <= *(int *)0xb8ca /* gold_high */ && (uVar1 < *(uint *)0xb8c8 /* gold_low */)))) &&
  ...
  if (0 < (int)local_6) {
    ...
    uVar2 = *(undefined4 *)0xb8c8 /* gold_low */;
    uVar7 = (uint)uVar2;
    *(int *)0xb8c8 /* gold_low */ = uVar7 - uVar1;
    *(int *)0xb8ca /* gold_high */ = ((int)((ulong)uVar2 >> 0x10) - ((int)uVar1 >> 0xf)) - (uint)(uVar7 < uVar1);
    ...
    *(undefined2 *)(pcVar9 + 0xb) = uVar13;
    pcVar9[0x14] = '\0';
    pcVar9[0x13] = '\0';
    place_object_on_map(*(undefined2 *)0xe52d /* dungeon_level */,&local_113,unaff_SS);
    uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
    uVar3 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
    uVar4 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    *(undefined1 *)((int)uVar4 + *(int *)((int)uVar3 + 5) * MAP_WIDTH + *(int *)((int)uVar2 + 7) + -0x50)
         = 0x20;
    uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
    *(undefined2 *)((int)uVar2 + 5) = *(undefined2 *)0xb86c /* player_y */;
    uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
    *(undefined2 *)((int)uVar2 + 7) = *(undefined2 *)0xb86e /* player_x */;
    uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
    uVar3 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9);
    ...
    uVar6 = lookup_table_b9c7(*(undefined2 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9),
                          *(undefined2 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d7));
    uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    *(undefined1 *)
     ((int)uVar2 + *(int *)((int)local_118 + 5) * MAP_WIDTH + *(int *)((int)local_118 + 7) + -0x50) =
         uVar6;
    redraw_dungeon_level(0x17);
    display_character_stats();
  }
  ...
  if (local_3 != '\0') {
    ...
    if (*param_1 == '\b') {
      ...
      if (*(int *)0xb894 == 0 && *(int *)0xb896 == 0) {
        *(undefined1 *)0xb918 /* has_light */ = 0;
        iVar2 = 0;
        if (*(int *)0xe52d /* dungeon_level */ == 1) {
          iVar2 = *(int *)0x78f1 * MAP_WIDTH;
          uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
...

{
  ...
  pcVar2 = (char *)param_1;
  if ((iVar6 == *(int *)0xb924) && (pcVar2 == (char *)*(undefined2 *)0xb922 /* wielded_weapon */)) {
    ...
    if (*param_1 == '\a') {
      ...
      *(undefined2 *)0xb922 /* wielded_weapon */ = pcVar2;
      *(int *)0xb924 = iVar6;
      *(int *)0xb882 = *(int *)(*(int *)(pcVar2 + 1) * 4 + -0x6185) + *(int *)(pcVar2 + 9);
      display_food_status();
    }
    else if (*param_1 == '\x06') {
      if (*(int *)0xb874 /* current_mana */ < 0x1d) {
        print_prompt();
        iVar3 = *(int *)(pcVar2 + 1);
        if (iVar3 == 7) {
          if (*(int *)0xb92a /* equipped_armor */ == 0 && *(int *)0xb92c == 0) {
            *(undefined2 *)0xb92a /* equipped_armor */ = pcVar2;
            *(int *)0xb92c = iVar6;
          ...
          if (*(int *)0xb932 /* equipped_ring2 */ == 0 && *(int *)0xb934 == 0) {
            *(undefined2 *)0xb932 /* equipped_ring2 */ = pcVar2;
            *(int *)0xb934 = iVar6;
            *(undefined2 *)0xb884 = *(undefined2 *)((int)*(undefined4 *)0xb932 /* equipped_ring2 */ + 9);
            local_5 = '\x01';
          }
          else {
          ...
          if (*(int *)0xb926 /* equipped_shield */ == 0 && *(int *)0xb928 == 0) {
            *(undefined2 *)0xb926 /* equipped_shield */ = pcVar2;
            *(int *)0xb928 = iVar6;
        ...
        else if (*(int *)0xb92e /* equipped_ring1 */ == 0 && *(int *)0xb930 == 0) {
          *(undefined2 *)0xb92e /* equipped_ring1 */ = pcVar2;
          *(int *)0xb930 = iVar6;
          local_5 = '\x01';
        }
        else {
        ...
        iVar3 = *(int *)0xb87c;
        iVar1 = *(int *)0xb87e;
        *(int *)0xb880 /* base_ac */ = iVar3 + iVar1;
        uVar7 = local_5 == '\0';
        if (!(bool)uVar7) {
  ...
  if ((bool)uVar4) {
    ...
    if (local_7 == 'a') {
      if (*(int *)0xb926 /* equipped_shield */ == 0 && *(int *)0xb928 == 0) {
        ...
        local_6 = *(undefined4 *)0xb926 /* equipped_shield */;
    ...
    if (local_7 == 'h') {
      if (*(int *)0xb92a /* equipped_armor */ == 0 && *(int *)0xb92c == 0) {
        ...
        local_6 = *(undefined4 *)0xb92a /* equipped_armor */;
        if (*(char *)((int)local_6 + 0x14) == '\0') {
          *(undefined2 *)0xb92a /* equipped_armor */ = 0;
          *(undefined2 *)0xb92c = 0;
          uVar3 = 0;
    ...
    if (local_7 == 'c') {
      if (*(int *)0xb932 /* equipped_ring2 */ == 0 && *(int *)0xb934 == 0) {
        ...
        local_6 = *(undefined4 *)0xb932 /* equipped_ring2 */;
        if (*(char *)((int)local_6 + 0x14) == '\0') {
          *(undefined2 *)0xb932 /* equipped_ring2 */ = 0;
          *(undefined2 *)0xb934 = 0;
          uVar3 = 0;
    ...
    uVar4 = local_7 == 'g';
    if ((bool)uVar4) {
      uVar4 = *(int *)0xb92e /* equipped_ring1 */ == 0 && *(int *)0xb930 == 0;
      if (*(int *)0xb92e /* equipped_ring1 */ == 0 && *(int *)0xb930 == 0) {
        display_score_with_fatal(0xff35);
        uVar3 = extraout_AH_34;
      }
      else {
        local_6 = *(undefined4 *)0xb92e /* equipped_ring1 */;
...
LAB_1000_a4bd:
    iVar2 = random_mod(4);
    *(int *)((int)*(undefined4 *)0xb91e /* inventory_list */ + 9) = iVar2 * 100 + 800;
    *(int *)0xb892 = *(int *)0xb892 + *(int *)((int)*(undefined4 *)0xb91e /* inventory_list */ + 9);
    display_score_with_fatal(*(int *)((int)*(undefined4 *)0xb91e /* inventory_list */ + 9) / 100 + 0x30);
  }
  uVar1 = *(undefined4 *)0xb91e /* inventory_list */;
    ...
    if (*(int *)0xb892 < -200) {
      ...
      if (*(int *)0xb892 < 0) {
        ...
        if (!(bool)uVar6 && !(bool)uVar7) {
          ...
          *(undefined1 *)0xb915 /* is_dying */ = 1;
          *(undefined2 *)0xb91a /* death_timer */ = 1;
          goto LAB_1000_a64e;
        }
      }
      if (*(int *)0xb892 < 0x32) {
...

{
  ...
  *param_5 = *(int *)0xb86c /* player_y */;
  *param_4 = *(int *)0xb86e /* player_x */;
  local_4 = 0;
  while( true ) {
    ...
    *param_4 = *param_4 + *param_2;
    ...
    uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    iVar3 = (int)uVar1 + *param_5 * MAP_WIDTH + *param_4;
    uVar4 = iVar3 == 0;
    uVar2 = CONCAT11((char)((uint)(*param_5 * MAP_WIDTH) >> 8),*(undefined1 *)(iVar3 + -0x50));
    puVar5 = local_24;
    uVar6 = unaff_SS;
    pad_and_copy_buffer(0x20,0xb76f,unaff_DS);
    create_bit_mask(puVar5,uVar6,uVar2);
    if ((!(bool)uVar4) || (*(char *)(*param_5 * MAP_WIDTH + *param_4 + -0xc) != ' ')) break;
  }
  if (*(char *)(*param_5 * MAP_WIDTH + *param_4 + -0xc) == ' ') {
    *param_5 = *param_5 - *param_3;
    *param_4 = *param_4 - *param_2;
  }
  return;
  ...
  if (*(char *)(local_8 * MAP_WIDTH + local_6 + -0xc) != ' ') {
    ...
    *(int *)(puVar4 + 0x2c) = *(int *)(puVar4 + 0x2c) + 1;
    ...
    if (((bool)uVar7) || (uVar7 = iVar1 == 0x10, (bool)uVar7)) {
      ...
      *(int *)0xb870 /* current_hp */ = *(int *)0xb870 /* current_hp */ / 2 + 1;
      display_character_stats();
    }
    else if (iVar1 == 8) {
      if (puVar4[0x29] == '\0') {
      ...
      if (puVar4[0x29] == '\0') {
        iVar3 = random_mod(*(int *)0xb888 /* player_level */ + *(int *)0xe52d /* dungeon_level */);
      ...
      *(int *)(puVar4 + 10) = *(int *)0xb870 /* current_hp */ / 2 + *(int *)(puVar4 + 10) + 1;
      *(int *)0xb870 /* current_hp */ = *(int *)0xb870 /* current_hp */ / 2 + 1;
      display_character_stats();
    }
    else if (iVar1 == 0x13) {
      ...
      if (iVar3 == 1) {
        if (puVar4[0x29] == '\0') {
          *(undefined2 *)(puVar4 + 10) = 1;
          iVar3 = random_mod(*(undefined2 *)0xb872 /* max_hp */);
          *(int *)0xb870 /* current_hp */ = iVar3 + 1;
        }
      }
      else {
        *(undefined2 *)(puVar4 + 10) = *(undefined2 *)(*(int *)(puVar4 + 4) * 0x2a + -0x5002);
        *(undefined2 *)0xb870 /* current_hp */ = 1;
      }
      display_character_stats();
    }
    else if (iVar1 == 0x14) {
      ...
      *(int *)0xb870 /* current_hp */ = *(int *)0xb870 /* current_hp */ + iVar3;
      if (*(int *)0xb872 /* max_hp */ < *(int *)0xb870 /* current_hp */) {
        *(undefined2 *)0xb870 /* current_hp */ = *(undefined2 *)0xb872 /* max_hp */;
      }
      display_character_stats();
...

{
  ...
  if (*(int *)(iVar4 + 9) == 0) {
    ...
    iVar3 = *(int *)(iVar4 + 1);
    if (iVar3 == 3) {
      iVar3 = (*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH;
      uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      iVar5 = (int)uVar1 + iVar3 + *(int *)0xb86e /* player_x */ + local_4;
      uVar8 = iVar5 == 0;
      ...
      if ((!(bool)uVar8) &&
         ((!(bool)((char)*(undefined2 *)0xb86c /* player_y */ + (char)local_6 & 1) ||
          (!(bool)((char)*(undefined2 *)0xb86e /* player_x */ + (char)local_4 & 1))))) {
        iVar3 = (*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH;
        uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
        iVar5 = (int)uVar1 + iVar3 + *(int *)0xb86e /* player_x */ + local_4;
        uVar8 = iVar5 == 0;
        ...
        if ((bool)uVar8) {
          FUN_1000_2214(*(int *)0xb86e /* player_x */ + local_4,*(int *)0xb86c /* player_y */ + local_6);
        }
        else {
          FUN_1000_2138(*(int *)0xb86e /* player_x */ + local_4,*(int *)0xb86c /* player_y */ + local_6);
        }
        redraw_dungeon_level(*(int *)0xb86c /* player_y */ + 1);
      }
    }
    else if (iVar3 == 4) {
      iVar3 = (*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH;
      ...
      if ((bool)uVar8) {
        ...
        FUN_1000_21b0(*(int *)0xb86e /* player_x */ + local_4,*(int *)0xb86c /* player_y */ + local_6);
        if (*(char *)((*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH + *(int *)0xb86e /* player_x */ + local_4 + -0xc) != ' ') {
          iVar3 = (*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH;
          uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
          iVar5 = (int)uVar1 + iVar3 + *(int *)0xb86e /* player_x */ + local_4;
          uVar8 = iVar5 == 0;
          ...
          create_bit_mask(puVar10,uVar7,uVar11);
          if (!(bool)uVar8) {
            find_item_at_coords(local_a,unaff_SS,*(int *)0xb86e /* player_x */ + local_4,*(int *)0xb86c /* player_y */ + local_6);
      ...
      if ((bool)uVar8) {
        ...
        uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
        *(undefined1 *)
         ((int)uVar1 + (*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH + *(int *)0xb86e /* player_x */ + local_4 + -0x50) = 0xf7;
        render_field_of_view();
      }
    }
    else if (iVar3 == 10) {
      if (*(char *)((*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH + *(int *)0xb86e /* player_x */ + local_4 + -0xc) == ' ') {
        ...
        if (((bool)uVar8) &&
           (populate_level_with_monsters(),
           *(int *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5499) != 0 ||
           *(int *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5497) != 0)) {
          local_34 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5499);
          uVar7 = (undefined2)((ulong)local_34 >> 0x10);
          iVar3 = (int)local_34;
          *(undefined1 *)(*(int *)(iVar3 + 0x1c) * MAP_WIDTH + *(int *)(iVar3 + 0x1e) + -0xc) = 0x20;
          *(int *)(iVar3 + 0x1c) = *(int *)0xb86c /* player_y */ + local_6;
          *(int *)(iVar3 + 0x1e) = *(int *)0xb86e /* player_x */ + local_4;
          *(undefined1 *)(*(int *)(iVar3 + 0x1c) * MAP_WIDTH + *(int *)(iVar3 + 0x1e) + -0xc) =
               *(undefined1 *)(iVar3 + 1);
          render_field_of_view();
        }
      ...
      if ((bool)uVar8) {
        iVar3 = random_mod(5);
        initialize_monster_or_item(local_10,unaff_SS,*(undefined2 *)0xe52d /* dungeon_level */,iVar3 + 1);
        place_object_on_map(*(undefined2 *)0xe52d /* dungeon_level */,local_10,unaff_SS);
        uVar7 = SUB42(local_10._0_4_,2);
        iVar3 = (int)local_10._0_4_;
        uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
        *(undefined1 *)((int)uVar1 + *(int *)(iVar3 + 5) * MAP_WIDTH + *(int *)(iVar3 + 7) + -0x50) =
             0x20;
        *(int *)(iVar3 + 5) = *(int *)0xb86c /* player_y */ + local_6;
        *(int *)(iVar3 + 7) = *(int *)0xb86e /* player_x */ + local_4;
      ...
      create_bit_mask(puVar10,unaff_SS,uVar7);
      if (!(bool)uVar8) {
        validate_window_coords(*(int *)0xb86c /* player_y */ + local_6 + 1,*(int *)0xb86e /* player_x */ + local_4);
        uVar11 = 0xe654;
        uVar7 = unaff_DS;
        ...
        uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
        *(undefined1 *)
         ((int)uVar1 + (*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH + *(int *)0xb86e /* player_x */ + local_4 + -0x50) = 0x20;
      }
    }
    else if (iVar3 == 0x11) {
      uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      if (*(char *)((int)uVar1 + (*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH + *(int *)0xb86e /* player_x */ + local_4 +
                   -0x50) == ' ') {
        uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
        *(undefined1 *)
         ((int)uVar1 + (*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH + *(int *)0xb86e /* player_x */ + local_4 + -0x50) =
             *(undefined1 *)0x1;
      }
    }
    else if (iVar3 == 0x15) {
      ...
      if (*(char *)((int)uVar1 + (*(int *)0xb86c /* player_y */ + local_6) * MAP_WIDTH + *(int *)0xb86e /* player_x */ + local_4 +
                   -0x50) == -9) {
        *(undefined1 *)(*(int *)0xe52d /* dungeon_level */ + 0x796d) = 0;
      }
    }
    else {
...

{
  ...
  uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
  uVar1 = *(undefined1 *)((int)uVar2 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */ + -0x50);
  bVar5 = (byte)((uint)(*(int *)0xb86c /* player_y */ * MAP_WIDTH) >> 8);
  ...
  *(undefined2 *)(iVar3 + 7) = *(undefined2 *)(param_1 + -8);
  uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
  if (*(char *)((int)uVar2 + *(int *)(param_1 + -10) * MAP_WIDTH + *(int *)(param_1 + -8) + -0x50) != ' '
     ) {
  ...
  *(undefined1 *)((int)uVar2 + *(int *)(iVar3 + 5) * MAP_WIDTH + *(int *)(iVar3 + 7) + -0x50) = uVar4;
  uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
  *(undefined1 *)((int)uVar2 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */ + -0x50) = uVar1;
  return;
}
...

{
  ...
  if (((*(int *)((int)*(undefined4 *)(param_1 + 4) + 1) == 0xc) &&
      (*(int *)0xb922 /* wielded_weapon */ != 0 || *(int *)0xb924 != 0)) &&
     (*(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 1) == 0xb)) {
    iVar1 = *(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 9);
...

{
  ...
  if (local_11[0] != '\0') {
    check_minimum_stats();
    iVar1 = random_mod(*(int *)0xb874 /* current_mana */ / 4 + 1);
    uVar4 = 0;
    local_e = *(int *)0xb874 /* current_mana */ / 4 + iVar1 + 1;
    ...
    FUN_1000_a91f(&local_e,unaff_SS,local_6,unaff_SS,local_8,unaff_SS,&local_a,unaff_SS,&local_c,
                  unaff_SS);
    iVar1 = local_a - *(int *)0xb86e /* player_x */;
    if (iVar1 < 0) {
      iVar1 = -iVar1;
    }
    local_e = local_c - *(int *)0xb86c /* player_y */;
    if (local_e < 0) {
      local_e = -local_e;
    }
    local_e = local_e + iVar1;
    if (*(char *)(local_c * MAP_WIDTH + local_a + -0xc) == ' ') {
      if ((local_c == *(int *)0xb86c /* player_y */) && (local_a == *(int *)0xb86e /* player_x */)) {
      ...
      iVar1 = ((*(int *)0xb888 /* player_level */ + *(int *)0xb878 /* strength */) - *(int *)((undefined1 *)local_15 + 8)) - local_e
              >> 0xf;
      combat_wrapper();
      uVar5 = 0;
      conditional_char_action();
...

{
  ...
  uVar6 = *(int *)0xb888 /* player_level */ / 2 + *(int *)0xb87a /* intelligence */;
  iVar9 = (int)uVar6 >> 0xf;
...
LAB_1000_bd9d:
    ...
    if (iVar9 == 1) {
      if (*(int *)0xb926 /* equipped_shield */ == 0 && *(int *)0xb928 == 0) {
        if (*(int *)0xb92a /* equipped_armor */ == 0 && *(int *)0xb92c == 0) {
          if ((*(int *)0xb932 /* equipped_ring2 */ != 0 || *(int *)0xb934 != 0) &&
             (*(int *)((int)*(undefined4 *)0xb932 /* equipped_ring2 */ + 9) < 5)) {
            local_20 = *(undefined4 *)0xb932 /* equipped_ring2 */;
        ...
        else if (*(int *)((int)*(undefined4 *)0xb92a /* equipped_armor */ + 9) < 5) {
          local_20 = *(undefined4 *)0xb92a /* equipped_armor */;
          uVar11 = (undefined2)((ulong)local_20 >> 0x10);
          iVar9 = (int)local_20;
          *(int *)(iVar9 + 9) = *(int *)(iVar9 + 9) + 1;
          *(undefined1 *)(iVar9 + 0x14) = 0;
      ...
      else if (*(int *)((int)*(undefined4 *)0xb926 /* equipped_shield */ + 9) < 5) {
        display_score_with_fatal(0x12f);
        *(int *)0xb87c = *(int *)0xb87c + 1;
        local_20 = *(undefined4 *)0xb926 /* equipped_shield */;
        uVar11 = (undefined2)((ulong)local_20 >> 0x10);
        iVar9 = (int)local_20;
        *(int *)(iVar9 + 9) = *(int *)(iVar9 + 9) + 1;
        *(undefined1 *)(iVar9 + 0x14) = 0;
      ...
      *(int *)0xb880 /* base_ac */ = *(int *)0xb87c + *(int *)0xb87e;
      ...
      if (*(int *)0xb922 /* wielded_weapon */ != 0 || *(int *)0xb924 != 0) {
        ...
        local_20 = *(undefined4 *)0xb922 /* wielded_weapon */;
        uVar11 = (undefined2)((ulong)local_20 >> 0x10);
        ...
        *(undefined1 *)((int)uVar2 + 0x719) = 1;
        ...
        while( true ) {
          ...
          while( true ) {
            ...
            if ((!(bool)uVar14) &&
               (*(char *)(*(int *)0xe52d /* dungeon_level */ * 0x719 + local_16 * MAP_WIDTH + local_14 + 0x70d) == '\0')) {
              validate_window_coords(local_16 + 1,
                            CONCAT11((char)((uint)(*(int *)0xe52d /* dungeon_level */ * 0x719) >> 8),
                                     (undefined1)local_14));
              uVar12 = 0xe654;
              uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
              uVar11 = unaff_DS;
      ...
      *(undefined1 *)0x9aab = 1;
      ...
      uVar12 = (undefined2)((ulong)*(undefined4 *)0xb8c8 /* gold_low */ >> 0x10);
      combat_wrapper();
      check_combat_and_handle_error();
      combat_check_and_handle_error();
      uVar11 = combat_check_with_error();
      *(undefined2 *)0xb8c8 /* gold_low */ = uVar11;
      *(undefined2 *)0xb8ca /* gold_high */ = uVar12;
      if (*(int *)0xb8ca /* gold_high */ < 0) {
        *(undefined2 *)0xb8c8 /* gold_low */ = 0;
        *(undefined2 *)0xb8ca /* gold_high */ = 0;
        *(int *)0xb872 /* max_hp */ = *(int *)0xb872 /* max_hp */ + -1;
        *(int *)0xb870 /* current_hp */ = *(int *)0xb870 /* current_hp */ / 2 + 1;
      }
      display_character_stats();
    }
      ...
      *(undefined1 *)0xb919 /* is_confused */ = 0;
      ...
      FUN_1000_20dd();
      iVar9 = random_mod(2);
      *(int *)0xe52d /* dungeon_level */ = (*(int *)0xe52d /* dungeon_level */ + -1) - iVar9;
      if (*(int *)0xe52d /* dungeon_level */ < 1) {
        *(undefined2 *)0xe52d /* dungeon_level */ = 1;
      }
      find_random_empty_floor_space(0xe52d,unaff_DS,0xb86e,unaff_DS,0xb86c,unaff_DS);
      FUN_1000_1a1a(*(undefined2 *)0xe52d /* dungeon_level */);
      *(undefined1 *)0xb919 /* is_confused */ = 0;
      redraw_dungeon_level(0x17);
      render_field_of_view();
    }
      ...
      *(undefined1 *)0xb8f7 /* is_stunned */ = 1;
      ...
      *(int *)0xb90f = iVar9 + 0x46;
      ...
      if (iVar9 == 0xb) {
        ...
        if (*(int *)0xb926 /* equipped_shield */ != 0 || *(int *)0xb928 != 0) {
          *(undefined1 *)((int)*(undefined4 *)0xb926 /* equipped_shield */ + 0x14) = 1;
          *(undefined1 *)((int)*(undefined4 *)0xb926 /* equipped_shield */ + 0x15) = 0;
        }
        if (*(int *)0xb92a /* equipped_armor */ != 0 || *(int *)0xb92c != 0) {
          *(undefined1 *)((int)*(undefined4 *)0xb92a /* equipped_armor */ + 0x14) = 1;
        }
        if (*(int *)0xb932 /* equipped_ring2 */ != 0 || *(int *)0xb934 != 0) {
          *(undefined1 *)((int)*(undefined4 *)0xb932 /* equipped_ring2 */ + 0x14) = 1;
        }
        if (*(int *)0xb92e /* equipped_ring1 */ != 0 || *(int *)0xb930 != 0) {
          *(undefined1 *)((int)*(undefined4 *)0xb92e /* equipped_ring1 */ + 0x14) = 1;
        }
        iVar9 = *(int *)0xb936;
        ...
        if (*(int *)0xb922 /* wielded_weapon */ != 0 || *(int *)0xb924 != 0) {
          *(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 9) = *(int *)((int)*(undefined4 *)0xb922 /* wielded_weapon */ + 9) + -1;
        }
      }
      else if (iVar9 == 0xf) {
        *(undefined1 *)0xb915 /* is_dying */ = 1;
        ...
        *(int *)0xb91a /* death_timer */ = iVar9 + 0x1e;
        if (*(int *)0xb874 /* current_mana */ < *(int *)0xb876 /* max_mana */) {
          *(int *)0xb874 /* current_mana */ = *(int *)0xb874 /* current_mana */ + 1;
        }
      }
      else if (iVar9 == 0x10) {
        ...
        if (*(int *)0xb926 /* equipped_shield */ != 0 || *(int *)0xb928 != 0) {
          *(undefined1 *)((int)*(undefined4 *)0xb926 /* equipped_shield */ + 0x14) = 0;
        }
        if (*(int *)0xb92a /* equipped_armor */ != 0 || *(int *)0xb92c != 0) {
          *(undefined1 *)((int)*(undefined4 *)0xb92a /* equipped_armor */ + 0x14) = 0;
        }
        if (*(int *)0xb932 /* equipped_ring2 */ != 0 || *(int *)0xb934 != 0) {
          *(undefined1 *)((int)*(undefined4 *)0xb932 /* equipped_ring2 */ + 0x14) = 0;
        }
        if (*(int *)0xb92e /* equipped_ring1 */ != 0 || *(int *)0xb930 != 0) {
          *(undefined1 *)((int)*(undefined4 *)0xb92e /* equipped_ring1 */ + 0x14) = 0;
        }
        iVar9 = *(int *)0xb936;
        local_20 = CONCAT22(iVar9,(undefined2)local_20);
        if (0 < iVar9) {
        ...
        if ((!(bool)(*(byte *)0xb86c /* player_y */ & 1)) && (!(bool)(*(byte *)0xb86e /* player_x */ & 1))) {
          if (*(int *)0xb86c /* player_y */ != 0x16) {
            FUN_1000_2138(*(undefined2 *)0xb86e /* player_x */,*(int *)0xb86c /* player_y */ + 1);
          }
          if (*(int *)0xb86c /* player_y */ != 2) {
            FUN_1000_2138(*(undefined2 *)0xb86e /* player_x */,*(int *)0xb86c /* player_y */ + -1);
          }
          if (*(int *)0xb86e /* player_x */ != 2) {
            FUN_1000_2138(*(int *)0xb86e /* player_x */ + -1,*(undefined2 *)0xb86c /* player_y */);
          }
          if (*(int *)0xb86e /* player_x */ != 0x4e) {
            FUN_1000_2138(*(int *)0xb86e /* player_x */ + 1,*(undefined2 *)0xb86c /* player_y */);
          }
          redraw_dungeon_level(0x17);
          render_field_of_view();
        ...
        while( true ) {
          uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
          iVar9 = (int)uVar2 + local_16 * MAP_WIDTH + *(int *)0xb86e /* player_x */;
          uVar14 = iVar9 == 0;
          ...
          if ((!(bool)uVar14) && ((bool)((byte)local_16 & 1))) {
            FUN_1000_2138(*(undefined2 *)0xb86e /* player_x */,local_16);
          }
        ...
        while( true ) {
          uVar2 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
          iVar9 = (int)uVar2 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + local_16;
          uVar14 = iVar9 == 0;
          uVar12 = CONCAT11((char)((uint)(*(int *)0xb86c /* player_y */ * MAP_WIDTH) >> 8),
          ...
          create_bit_mask(puVar16,uVar11,uVar12);
          if ((!(bool)uVar14) && ((bool)((byte)local_16 & 1))) {
            FUN_1000_2138(local_16,*(undefined2 *)0xb86c /* player_y */);
          }
        ...
        *(undefined2 *)(*(int *)0xe52d /* dungeon_level */ * 2 + 0x799b) = 0;
      }
      else if (iVar9 == 0x15) {
        display_score_with_fatal(0xffb8);
        local_e = (char *)*(undefined4 *)0xb91e /* inventory_list */;
        while( true ) {
                ...
                while( true ) {
                  ...
                  *(undefined1 *)
                   ((int)uVar2 + *(int *)(pcVar10 + 5) * MAP_WIDTH + *(int *)(pcVar10 + 7) + -0x50) =
                       uVar14;
                  *(undefined1 *)
                   (*(int *)0xe52d /* dungeon_level */ * 0x719 + *(int *)(pcVar10 + 5) * MAP_WIDTH + *(int *)(pcVar10 + 7) +
                   0x70d) = 0;
                  prepend_item_to_list(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9,unaff_DS,&local_12,unaff_SS);
                  cVar4 = is_type_7_subtype_12((char *)local_e,local_e._2_2_);
                  if (cVar4 == '\0') {
                    *(int *)0xb8c0 = *(int *)0xb8c0 + -1;
...

{
  ...
  *(int *)0xb909 = *(int *)0xb909 + 200 + iVar4;
  ...
  if (iVar4 == 1) {
    if (*(char *)0xb8f0 /* confusion_lock */ == '\0') {
    ...
    if (*(int *)0xb870 /* current_hp */ == *(int *)0xb872 /* max_hp */) {
      iVar4 = random_mod(6);
      *(int *)0xb872 /* max_hp */ = *(int *)0xb872 /* max_hp */ + 1 + iVar4;
      *(undefined2 *)0xb870 /* current_hp */ = *(undefined2 *)0xb872 /* max_hp */;
    }
    else {
      iVar4 = random_mod(*(int *)0xb888 /* player_level */ * 3);
      *(int *)0xb870 /* current_hp */ = *(int *)0xb888 /* player_level */ * 2 + *(int *)0xb870 /* current_hp */ + iVar4;
      if (*(int *)0xb872 /* max_hp */ < *(int *)0xb870 /* current_hp */) {
        *(undefined2 *)0xb870 /* current_hp */ = *(undefined2 *)0xb872 /* max_hp */;
      }
    }
    if (*(char *)0xb8ee /* needs_full_update */ == '\0') {
      ...
      *(undefined1 *)0xb8ee /* needs_full_update */ = 0;
      redraw_dungeon_level(0x17);
    }
    goto LAB_1000_d16b;
  }
  if (iVar4 == 2) {
    ...
    if ((*(char *)0xb8ee /* needs_full_update */ == '\0') && (*(char *)0xb8ed /* is_blind */ == '\0')) {
      display_character_stats();
    }
    else {
      *(undefined1 *)0xb8ee /* needs_full_update */ = 0;
      *(undefined1 *)0xb8ed /* is_blind */ = 0;
      redraw_dungeon_level(0x17);
    }
    goto LAB_1000_d16b;
  }
  if (iVar4 == 3) {
    ...
    uVar5 = random_mod(4);
    *(int *)0xb874 /* current_mana */ = *(int *)0xb874 /* current_mana */ + 1 + uVar5 / 3;
    *(int *)0xb876 /* max_mana */ = *(int *)0xb876 /* max_mana */ + 1;
    if (*(int *)0xb876 /* max_mana */ < *(int *)0xb874 /* current_mana */) {
      *(undefined2 *)0xb876 /* max_mana */ = *(undefined2 *)0xb874 /* current_mana */;
    }
    display_character_stats();
    goto LAB_1000_d16b;
  }
  if (iVar4 == 4) {
    ...
    if (*(int *)0xb874 /* current_mana */ < *(int *)0xb876 /* max_mana */) {
      *(undefined2 *)0xb874 /* current_mana */ = *(undefined2 *)0xb876 /* max_mana */;
      ...
      iVar4 = random_mod(2);
      *(int *)0xb874 /* current_mana */ = *(int *)0xb874 /* current_mana */ + 2 + iVar4;
      *(undefined2 *)0xb876 /* max_mana */ = *(undefined2 *)0xb874 /* current_mana */;
    }
    display_character_stats();
    goto LAB_1000_d16b;
  ...
  if (iVar4 != 6) {
    if (iVar4 == 7) {
      ...
      *(int *)0xb8fd = iVar4 + 0x32;
      ...
      while( true ) {
        ...
        *(undefined1 *)((int)uVar2 + 0x719) = 0;
        ...
        while( true ) {
          for (local_12 = 1;
              *(undefined1 *)(local_10 * 0x719 + local_14 * MAP_WIDTH + local_12 + 0x70d) = 0,
      ...
      *(undefined1 *)0xb915 /* is_dying */ = 1;
      iVar4 = random_mod(10);
      *(int *)0xb91a /* death_timer */ = iVar4 + 0x14;
    }
    else if (iVar4 == 9) {
      if (*(char *)0xb916 /* is_hasted */ == '\0') {
        display_score_with_fatal(0x72);
        *(undefined1 *)0xb8ec /* is_paralyzed */ = 1;
        iVar4 = random_mod(5);
        *(int *)0xb8f9 = iVar4 + 10;
      }
      else {
      ...
      *(undefined1 *)0xb8f0 /* confusion_lock */ = 1;
      *(undefined1 *)0xb913 = 1;
      *(int *)0xb87a /* intelligence */ = *(int *)0xb87a /* intelligence */ + -1;
      if (*(int *)0xb87a /* intelligence */ < 1) {
      ...
      *(int *)0xb892 = *(int *)0xb892 + 500 + iVar4;
      ...
      level_up_character();
      uVar5 = random_mod(*(int *)(*(int *)0xb888 /* player_level */ * 2 + -0x46b8) -
                            *(int *)((*(int *)0xb888 /* player_level */ + -1) * 2 + -0x46b8));
      *(int *)0xb886 /* experience */ = *(int *)((*(int *)0xb888 /* player_level */ + -1) * 2 + -0x46b8) + uVar5 / 2;
      display_character_stats();
    }
    else if (iVar4 == 0xf) {
      lose_experience_level();
      if (*(int *)0xb888 /* player_level */ < 2) {
        *(undefined2 *)0xb886 /* experience */ = 0;
      }
      else {
        iVar4 = random_mod(*(int *)(*(int *)0xb888 /* player_level */ * 2 + -0x46b8) -
                              *(int *)((*(int *)0xb888 /* player_level */ + -1) * 2 + -0x46b8));
        *(int *)0xb886 /* experience */ = *(int *)(*(int *)0xb888 /* player_level */ * 2 + -0x46b8) - iVar4;
      }
      if (*(int *)0xb886 /* experience */ < 0) {
        *(undefined2 *)0xb886 /* experience */ = 0;
      }
...
LAB_1000_cfc2:
        ...
        if (((((local_15 != '\0') &&
              ((local_a._2_2_ != *(int *)0xb924 ||
               ((char *)local_a != (char *)*(undefined2 *)0xb922 /* wielded_weapon */)))) &&
             ((local_a._2_2_ != *(int *)0xb928 || ((char *)local_a != (char *)*(undefined2 *)0xb926 /* equipped_shield */)
              ))) && ((((local_a._2_2_ != *(int *)0xb934 ||
                        ((char *)local_a != (char *)*(undefined2 *)0xb932 /* equipped_ring2 */)) &&
                       ((local_a._2_2_ != *(int *)0xb92c ||
                        ((char *)local_a != (char *)*(undefined2 *)0xb92a /* equipped_armor */)))) &&
                      ((local_a._2_2_ != *(int *)0xb930 ||
                       ((char *)local_a != (char *)*(undefined2 *)0xb92e /* equipped_ring1 */)))))) &&
...
LAB_1000_cb35:
    iVar4 = random_mod(3);
    *(int *)0xb874 /* current_mana */ = (*(int *)0xb874 /* current_mana */ + -1) - iVar4;
  }
  else {
    find_highest_bit();
    char_create_wrapper();
  ...
  display_character_stats();
LAB_1000_d16b:
  uVar11 = *(int *)0xb874 /* current_mana */ == 0x1c;
  if (0x1c < *(int *)0xb874 /* current_mana */) {
    uVar11 = *(int *)0xb926 /* equipped_shield */ == 0 && *(int *)0xb928 == 0;
    if (*(int *)0xb926 /* equipped_shield */ != 0 || *(int *)0xb928 != 0) {
      local_a = (char *)*(undefined4 *)0xb91e /* inventory_list */;
      while( true ) {
        iVar4 = (int)((ulong)local_a >> 0x10);
        pcVar8 = (char *)local_a;
        if ((iVar4 == *(int *)0xb928) && (pcVar8 == (char *)*(undefined2 *)0xb926 /* equipped_shield */)) break;
      ...
      *(undefined2 *)0xb928 = 0;
      ...
      uVar11 = 1;
      *(undefined2 *)0xb87c = 0;
      *(undefined2 *)0xb880 /* base_ac */ = *(undefined2 *)0xb87e;
      display_character_stats();
    }
  }
...

{
  ...
  if (((param_2 == 0x54) || (param_2 == 0x52)) || (param_2 == 0x61)) {
    if (*(int *)0xb8c0 < 1) {
      show_message_and_clear_flag(&stack0xfffe,0x4b);
            ...
            (uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4),
            *(char *)((int)uVar1 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */ + -0x50) != ' ')) {
    ...
    else if ((((*(int *)0xb926 /* equipped_shield */ != 0 || *(int *)0xb928 != 0) &&
              (*(int *)0xb92a /* equipped_armor */ != 0 || *(int *)0xb92c != 0)) &&
             (*(int *)0xb932 /* equipped_ring2 */ != 0 || *(int *)0xb934 != 0)) &&
            (*(int *)0xb92e /* equipped_ring1 */ != 0 || *(int *)0xb930 != 0)) {
  ...
  if (local_4 != '\0') {
    ...
    if ((local_8 < 1) || (uVar6 = local_8 == *(int *)0xb8c2, *(int *)0xb8c2 < local_8)) {
      ...
      local_12 = (char *)*(undefined4 *)0xb91e /* inventory_list */;
      check_minimum_stats();
      local_14 = local_8 + -1;
      iVar3 = 0;
      if (0 < local_14) {
...

{
  ...
  *(int *)0xb8c6 = 0x26 - (*(int *)0xb874 /* current_mana */ * -2 + 0x20);
  if (*(int *)0xb8c6 < 0xf) {
...

{
  ...
  iVar3 = (*(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1c) + param_3) * MAP_WIDTH;
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
  ...
  if (((bool)uVar5) &&
     (*(char *)((*(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1c) + param_3) * MAP_WIDTH +
...
LAB_1000_d991:
    ...
    if (((!(bool)uVar5) &&
        ...
        ) || ((*(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1c) + param_3 == *(int *)0xb86c /* player_y */ &&
              (*(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1e) + param_2 == *(int *)0xb86e /* player_x */))))
    goto LAB_1000_d991;
    local_4 = '\0';
  }
  if (local_4 != '\0') {
       ...
       (iVar3 = random_mod(*(int *)((int)*(undefined4 *)(param_1 + -8) + 0x12) + 1), iVar3 == 9))
    {
      ...
      if (!(bool)uVar5) {
        ...
        if (!(bool)uVar5) {
          uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
          *(undefined1 *)
           ((int)uVar1 + (*(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1c) + param_3) * MAP_WIDTH +
...

{
  ...
  if ((local_8 != *(int *)0xb86c /* player_y */) || (local_6 != *(uint *)0xb86e /* player_x */)) {
    if (*(char *)*(undefined4 *)(param_1 + -8) == 'X') {
      uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
      iVar4 = (int)uVar1 + local_8 * MAP_WIDTH + local_6;
      uVar7 = iVar4 == 0;
      uVar12 = CONCAT11((char)((uint)(local_8 * MAP_WIDTH) >> 8),*(undefined1 *)(iVar4 + -0x50));
      puVar11 = local_28;
      uVar6 = unaff_SS;
      zero_word_array_16(puVar11);
    ...
    *(uint *)(param_1 + -0xb) = uVar3 & 0xff;
    if ((*(char *)((int)*(undefined4 *)(param_1 + -8) + 0x23) != '\0') &&
      ...
      if (*(char *)0xb8f2 /* is_teleporting */ == '\0') {
        ...
        validate_window_coords((0xd - *(int *)0xb86c /* player_y */) + *(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1c),
                      (*(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1e) + 0x27) - *(int *)0xb86e /* player_x */)
        ;
      }
      if (*(char *)(*(int *)0xe52d /* dungeon_level */ * 0x719 +
                    *(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1c) * MAP_WIDTH +
                    *(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1e) + 0x70d) != '\0') {
        iVar4 = *(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1c) * MAP_WIDTH;
        uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
...
LAB_1000_de55:
    ...
    *(undefined1 *)
      ...
      *(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1e) + -0xc) =
         *(undefined1 *)((int)*(undefined4 *)(param_1 + -8) + 1);
    if (((*(char *)0xb8f8 != '\0') && (*(char *)0xb8f2 /* is_teleporting */ == '\0')) &&
       (*(char *)((int)*(undefined4 *)(param_1 + -8) + 0x27) == '\0')) {
      ...
      if (!(bool)uVar7) {
        ...
        if (!(bool)uVar7) {
          ...
          if (!bVar8 && !bVar10) {
            ...
            uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
            *(undefined1 *)
             ((int)uVar1 + *(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1c) * MAP_WIDTH +
              *(int *)((int)*(undefined4 *)(param_1 + -8) + 0x1e) + -0x50) = 0x20;
            remove_item_from_list(*(int *)0xe52d /* dungeon_level */ * 4 + -0x54d9,unaff_DS,
...
LAB_1000_e115:
  if ((*(char *)0xb8f0 /* confusion_lock */ != '\0') && (*(int *)(param_1 + -8) != 0 || *(int *)(param_1 + -6) != 0)) {
...

{
  ...
  if (9 < *(int *)(*(int *)0xe52d /* dungeon_level */ * 2 + 0x799b)) {
    apply_heroism_effect();
  }
  local_a = (byte *)*(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + -0x5499);
LAB_1000_e1be:
  do {
    if (*param_1 == '\0') {
      return;
      ...
      if (*(char *)0xb8f6 /* is_wizard */ == '\0') {
        ...
        if (*(int *)(pbVar10 + 0x2a) == 0) {
          if ((pbVar10[0x25] == 0) || (pbVar10[0x26] == 0)) {
            local_17 = *(int *)0xb86c /* player_y */ - *(int *)(pbVar10 + 0x1c);
            local_13 = get_sign(&local_17,unaff_SS);
            local_15 = *(int *)0xb86e /* player_x */ - *(int *)((byte *)local_a + 0x1e);
            uVar15 = local_15 == 0;
              ...
              if ((bool)uVar15) {
                if ((*local_a == 0xea) && (pbVar10[0x22] != 0)) {
                  *(int *)(pbVar10 + 0x20) = *(int *)(pbVar10 + 0x20) + -1;
                  ...
                  if (*(int *)0xe52d /* dungeon_level */ == 0) {
                    iVar5 = (int)*(undefined4 *)0x4 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */;
                    uVar14 = iVar5 == 0;
                    uVar7 = CONCAT11((char)((uint)(*(int *)0xb86c /* player_y */ * MAP_WIDTH) >> 8),
                ...
                if ((*local_a == 0x48) &&
                   (cVar4 = are_coordinates_adjacent(*(undefined2 *)0xb86e /* player_x */,*(undefined2 *)0xb86c /* player_y */,
              ...
              if (*(char *)((int)uVar3 + *(int *)((byte *)local_a + 0x1c) * MAP_WIDTH +
                ...
                if (((bVar2 == 0x41) || (bVar2 == 0x67)) || (bVar2 == 0x56)) {
                  ...
                  *(undefined1 *)
                  ...
                  char_create_wrapper();
                  if (!(bool)uVar14 && !(bool)uVar15) {
                    *(undefined1 *)(*(int *)0xe52d /* dungeon_level */ + 0x796d) = 1;
                  }
                }
              }
LAB_1000_e77e:
...

{
  ...
  if (param_1 == '\0') {
    uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    *(undefined1 *)((int)uVar1 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */ + -0x50) =
         *(undefined1 *)0x0;
  }
  FUN_1000_20dd();
  *(int *)0xe52d /* dungeon_level */ = *(int *)0xe52d /* dungeon_level */ + 1;
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
  if (*(char *)((int)uVar1 + 0x71a) == '\0') {
    draw_dungeon_border(*(undefined2 *)0xe52d /* dungeon_level */);
    generate_dungeon_level(*(undefined2 *)0xe52d /* dungeon_level */);
    spawn_monsters(*(undefined2 *)0xe52d /* dungeon_level */);
  }
  FUN_1000_1a1a(*(undefined2 *)0xe52d /* dungeon_level */);
  *(undefined1 *)0xb919 /* is_confused */ = 0;
  if (param_1 == '\0') {
    ...
    *(undefined2 *)0xb86c /* player_y */ = *(undefined2 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 0x78ed);
    *(undefined2 *)0xb86e /* player_x */ = *(undefined2 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 0x78ef);
  }
  redraw_dungeon_level(0x17);
  display_character_stats();
  return;
...

{
  ...
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
  iVar5 = (int)uVar1 + param_3 * MAP_WIDTH + param_2;
  uVar6 = iVar5 == 0;
  uVar3 = CONCAT11((char)(param_3 * MAP_WIDTH >> 8),*(undefined1 *)(iVar5 + -0x50));
  puVar7 = local_24;
  uVar4 = unaff_SS;
  pad_and_copy_buffer(0x20,0xb76f,unaff_DS);
  create_bit_mask(puVar7,uVar4,uVar3);
  if (((bool)uVar6) || (*(char *)0xb8f3 != '\0')) {
    ...
    iVar5 = (int)uVar1 + param_3 * MAP_WIDTH + param_2;
    uVar6 = iVar5 == 0;
    uVar4 = CONCAT11((char)(param_3 * MAP_WIDTH >> 8),*(undefined1 *)(iVar5 + -0x50));
    puVar7 = local_44;
...

{
  ...
  uVar10 = 0x1000;
  *param_2 = '\0';
  local_a = *(int *)0xb86c /* player_y */;
  local_8 = *(int *)0xb86e /* player_x */;
  if (*(char *)0xb8ef != '\0') {
    uVar10 = 0x214c;
    param_3 = random_mod(4);
    param_3 = param_3 + 1;
  }
  cVar2 = is_tile_passable(&stack0xfffe,*(int *)0xb86e /* player_x */ + *(int *)(param_3 * 4 + -0x464c),
                        *(int *)0xb86c /* player_y */ + *(int *)(param_3 * 4 + -0x464e));
  if (cVar2 == '\0') {
    *param_2 = '\x01';
  }
  else {
    local_a = *(int *)0xb86c /* player_y */ + *(int *)(param_3 * 4 + -0x464e);
    local_8 = *(int *)0xb86e /* player_x */ + *(int *)(param_3 * 4 + -0x464c);
  }
  if ((*param_2 != '\0') || (*(char *)0xb8f6 /* is_wizard */ != '\0')) {
    put_char_at_pos(0x20,*(undefined2 *)0xb86e /* player_x */,*(undefined2 *)0xb86c /* player_y */);
    *(int *)0xb86c /* player_y */ = local_a;
    *(int *)0xb86e /* player_x */ = local_8;
    render_field_of_view();
    goto LAB_1000_ed19;
  }
  local_b = '\x01';
...
LAB_1000_eadc:
      ...
      *(undefined1 *)0xb919 /* is_confused */ = 0;
      ...
      put_char_at_pos(CONCAT11(extraout_AH_00,0x20),*(undefined2 *)0xb86e /* player_x */,*(undefined2 *)0xb86c /* player_y */);
      *(int *)0xb86c /* player_y */ = local_a;
      *(int *)0xb86e /* player_x */ = local_8;
      render_field_of_view();
    }
...
LAB_1000_eb33:
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
  if ((((*(char *)((int)uVar1 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */ + -0x50) == -9) &&
       (*(char *)0xb8f1 == '\0')) && (cVar2 = check_inventory_has_item(0x12), cVar2 == '\0')) &&
     (*(char *)0xb8f6 /* is_wizard */ == '\0')) {
    check_minimum_stats();
    uVar16 = 0xe654;
    uVar15 = unaff_DS;
    ...
    if (*(int *)0xb909 < 400) {
      *(undefined2 *)0xb909 = 3000;
      if (*(char *)(*(int *)0xe52d /* dungeon_level */ + 0x796d) != '\0') {
        cVar2 = check_inventory_has_item(2);
        uVar12 = 0;
        uVar11 = cVar2 == '\0';
        if (!(bool)uVar11) {
        ...
        iVar9 = random_mod(2);
        *(int *)0xb874 /* current_mana */ = (*(int *)0xb874 /* current_mana */ + -1) - iVar9;
        if (*(int *)0xb874 /* current_mana */ < 1) {
...
LAB_1000_ec9a:
  if ((*param_1 != '\0') && (local_b != '\0')) {
    uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    iVar9 = (int)uVar1 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */;
    uVar12 = iVar9 == 0;
    uVar3 = CONCAT11((char)((uint)(*(int *)0xb86c /* player_y */ * MAP_WIDTH) >> 8),*(undefined1 *)(iVar9 + -0x50));
    puVar14 = local_2b;
    uVar10 = unaff_SS;
    pad_and_copy_buffer(0x20,0xb7cf,unaff_DS);
...
LAB_1000_ed19:
  ...
  if ((((!(bool)uVar12) && (*(char *)0xb8f1 == '\0')) &&
      (uVar4 = check_inventory_has_item(0x12), (char)uVar4 == '\0')) && (*(char *)0xb8f6 /* is_wizard */ == '\0')) {
    advance_to_next_level(uVar4 & 0xff00);
  }
  uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
  iVar9 = (int)uVar1 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */;
  uVar12 = iVar9 == 0;
  uVar10 = CONCAT11((char)((uint)(*(int *)0xb86c /* player_y */ * MAP_WIDTH) >> 8),*(undefined1 *)(iVar9 + -0x50));
  puVar14 = local_2b;
  zero_word_array_16(puVar14);
  ...
  if (((!(bool)uVar12) && (*(char *)0xb8f1 == '\0')) &&
     ((cVar2 = check_inventory_has_item(0x12), cVar2 == '\0' && (*(char *)0xb8f6 /* is_wizard */ == '\0')))) {
    iVar9 = random_mod(5);
    iVar5 = random_mod(5);
    iVar6 = random_mod(5);
    iVar7 = random_mod(5);
    *(int *)0xb870 /* current_hp */ = ((((*(int *)0xb870 /* current_hp */ + -4) - iVar7) - iVar6) - iVar5) - iVar9;
    if (*(int *)0xe52d /* dungeon_level */ == 0xf) {
      iVar9 = random_mod(5);
      iVar5 = random_mod(5);
      iVar6 = random_mod(5);
      iVar7 = random_mod(5);
    ...
    uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    *(undefined1 *)((int)uVar1 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */ + -0x50) = 0x20;
    iVar9 = random_mod(2);
...

{
  ...
  *(int *)0xb86c /* player_y */ = (iVar1 + 1) * 2;
  iVar1 = random_mod(0x27);
  *(int *)0xb86e /* player_x */ = (iVar1 + 1) * 2;
  FUN_1000_1a1a(1);
  display_character_stats();
  *(undefined1 *)(param_1 + -7) = 1;
  *(undefined2 *)0xe535 /* min_visible_row */ = 1;
  *(undefined2 *)0xe537 /* max_visible_row */ = 1;
  render_field_of_view();
  return;
}
...

{
  ...
  *(undefined1 *)(param_1 + -5) = 1;
  ...
  if ((((local_3 == 0x32) || (local_3 == 0x34)) || (local_3 == MONSTER_SIZE)) || (local_3 == 0x38)) {
    ...
    iVar3 = *(int *)0xb86c /* player_y */ * MAP_WIDTH;
    uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    if ((((*(char *)((int)uVar1 + iVar3 + *(int *)0xb86e /* player_x */ + -0x50) == -0x11) &&
         (*(char *)0xb8f1 == '\0')) && (iVar3 = check_inventory_has_item(0x12), (char)iVar3 == '\0')) ||
       (uVar4 = (undefined1)((uint)iVar3 >> 8), *(char *)0xb917 != '\0')) {
      iVar3 = *(int *)(*(int *)0xe52d /* dungeon_level */ * 4 + 0x792d);
      if (((iVar3 == *(int *)0xb86c /* player_y */) &&
          (iVar3 = *(int *)(*(int *)0xe52d /* dungeon_level */ * 4 + 0x792f), iVar3 == *(int *)0xb86e /* player_x */)) ||
         (*(char *)0xb917 != '\0')) {
    ...
    if ((*(char *)((int)uVar1 + iVar3 + *(int *)0xb86e /* player_x */ + -0x50) == -0x11) ||
       (*(char *)0xb917 != '\0')) {
      if (((*(int *)(*(int *)0xe52d /* dungeon_level */ * 4 + 0x78ed) == *(int *)0xb86c /* player_y */) &&
          (*(int *)(*(int *)0xe52d /* dungeon_level */ * 4 + 0x78ef) == *(int *)0xb86e /* player_x */)) || (*(char *)0xb917 != '\0')) {
        FUN_1000_20dd();
        *(int *)0xe52d /* dungeon_level */ = *(int *)0xe52d /* dungeon_level */ + -1;
        if (*(int *)0xe52d /* dungeon_level */ < 1) {
          ...
          FUN_1000_1a1a(*(undefined2 *)0xe52d /* dungeon_level */);
          *(undefined1 *)0xb919 /* is_confused */ = 0;
          *(undefined2 *)0xb86c /* player_y */ = *(undefined2 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 0x792d);
          *(undefined2 *)0xb86e /* player_x */ = *(undefined2 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 0x792f);
    ...
    if ((*(char *)0xb8ed /* is_blind */ == '\0') && (*(char *)0xb8ee /* needs_full_update */ == '\0')) {
      redraw_dungeon_level(0x17);
            ...
            ((local_3 == 0x4c || ((local_3 == 0x52 || (local_3 == 0x6c)))))))) || (local_3 == 0x62))
  {
    ...
    iVar3 = *(int *)0xb86c /* player_y */ * MAP_WIDTH;
    uVar1 = *(undefined4 *)(*(int *)0xe52d /* dungeon_level */ * 4 + 4);
    if (*(char *)((int)uVar1 + iVar3 + *(int *)0xb86e /* player_x */ + -0x50) == -0x65) {
...

{
  ...
  if (local_4 != 0) {
    ...
    if (2 < uVar2) {
      ...
      *(int *)0xb870 /* current_hp */ = *(int *)0xb870 /* current_hp */ + iVar1;
      if (*(int *)0xb872 /* max_hp */ < *(int *)0xb870 /* current_hp */) {
        *(undefined2 *)0xb870 /* current_hp */ = *(undefined2 *)0xb872 /* max_hp */;
      }
      display_character_stats();
...

{
  ...
  while (is_alive != '\0') {
    ...
    if (*(char *)0xb915 /* is_dying */ == '\0') {
      main_game_command_loop(&stack0xfffe,turn_processed,unaff_SS);
    }
    else {
      *(int *)0xb91a /* death_timer */ = *(int *)0xb91a /* death_timer */ + -1;
      if (*(int *)0xb91a /* death_timer */ == 0) {
        check_minimum_stats();
    ...
    if (turn_processed[0] != '\0') {
      ...
      if (is_alive != '\0') {
        ...
        if ((*(int *)0xb890 == 0) && (*(int *)0xb870 /* current_hp */ < *(int *)0xb872 /* max_hp */)) {
          *(int *)0xb870 /* current_hp */ = *(int *)0xb870 /* current_hp */ + 1;
          *(int *)0xb890 = (0xf - *(int *)0xe52d /* dungeon_level */) / 2;
          display_character_stats();
        }
        ...
        if (*(char *)0xb916 /* is_hasted */ != '\0') {
          update_all_monsters(&is_alive,unaff_SS);
          *(int *)0xb91c /* haste_timer */ = *(int *)0xb91c /* haste_timer */ + -1;
          if (*(int *)0xb91c /* haste_timer */ == 0) {
            *(undefined1 *)0xb916 /* is_hasted */ = 0;
            check_minimum_stats();
        ...
        if (((cVar1 != '\0') && (iVar2 = random_mod(200), iVar2 == 0)) && (1 < *(int *)0xb874 /* current_mana */)) {
...

{
  ...
  while( true ) {
    ...
    *(undefined1 *)(local_4 + 0x796d) = 0;
    local_8 = 1;
    while( true ) {
      for (local_6 = 1; *(undefined1 *)(local_4 * 0x719 + local_8 * MAP_WIDTH + local_6 + 0x70d) = 0,
