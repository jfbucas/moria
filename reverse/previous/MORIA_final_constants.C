...
LAB_1000_eadc:
      ...
      *(int *)0xb86e /* player_x */ = local_8;
      ...
      if ((*(char *)0xb8f1 != '\0') || (ch = check_inventory_has_item(ITEM_LEVITATION), ch != '\0')) {
...
LAB_1000_eb33:
  ...
  if ((((*(char *)((int)uVar1 + *(int *)0xb86c /* player_y */ * MAP_WIDTH + *(int *)0xb86e /* player_x */ + -0x50) == -9) &&
       (*(char *)0xb8f1 == '\0')) && (ch = check_inventory_has_item(ITEM_LEVITATION), ch == '\0')) &&
...
LAB_1000_ed19:
  ...
  if ((((!(bool)uVar12) && (*(char *)0xb8f1 == '\0')) &&
      (value = check_inventory_has_item(ITEM_LEVITATION), (char)value == '\0')) && (*(char *)0xb8f6 /* is_wizard */ == '\0')) {
  ...
  if (((!(bool)uVar12) && (*(char *)0xb8f1 == '\0')) &&
     ((ch = check_inventory_has_item(ITEM_LEVITATION), ch == '\0' && (*(char *)0xb8f6 /* is_wizard */ == '\0')))) {
    iVar9 = random_mod(5);
    random_val = random_mod(5);
    random_val = random_mod(5);
    random_val = random_mod(5);
  ...
  *(undefined1 *)(x_pos + -5) = 1;
  ...
  if ((((local_3 == 0x32) || (local_3 == 0x34)) || (local_3 == MONSTER_SIZE)) || (local_3 == 0x38)) {
    ...
    if ((((*(char *)((int)uVar1 + iVar3 + *(int *)0xb86e /* player_x */ + -0x50) == -0x11) &&
         (*(char *)0xb8f1 == '\0')) && (iVar3 = check_inventory_has_item(ITEM_LEVITATION), (char)iVar3 == '\0')) ||
